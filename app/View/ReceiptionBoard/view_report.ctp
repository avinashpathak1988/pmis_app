        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    ...
                    <?php }else if(isset($this->request->data['WelfareDetail']['status']) && $this->request->data['WelfareDetail']['status']=='Saved'){ ?>

                        <span style="text-align: center;margin-top: 10px;margin-left: 20%;" class="badge badge-success"><?php echo "Forwaded"; ?></span>
