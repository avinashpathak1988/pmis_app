                ...
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    ...
                    <div style="float:right;padding-top: 7px;">
                        <?php if ($this->Session->read('Auth.User.usertype_id')== Configure::read('OFFICERINCHARGE_USERTYPE')) {
                            ...
                            // echo $this->Html->link('',array('action'=>'addSelectPrisoner'),array('class' => 'btn btn-mini btn-primary'));
                            
                        }elseif ($this->Session->read('Auth.User.usertype_id')== Configure::read('RECEPTIONIST_USERTYPE')) {
                            
                        }
                        else{ echo $this->Html->link('Add New ',array('action'=>'addSelectPrisoner'),array('class' => 'btn btn-mini btn-primary'));}?>
                        &nbsp;&nbsp; 
                    </div>
                </div>
...
<?php
$ajaxUrlList = $this->Html->url(array('controller'=>'ReceiptionBoard','action'=>'listAjax'));
?>
