...
<table id="wardCellTable" class="table table-bordered table-striped table-responsive">
  <thead>
    <tr>
      ...
      <th>
        <?php                 
          echo $this->Paginator->sort('WardCell.cell_name','Cell No',array('update'=>'#listingDiv','evalScripts' => true,'url'=>array('controller' => 'WardCells','action' => 'indexAjax')));
          ?>
      </th>
...
?>
    <tr>
      ...
      <td><?php echo $wardcell['WardCell']['cell_name'];?></td>
      <td><?php echo $wardcell['WardCell']['cell_no'];?></td>
      </td>
      <td class="actions">
