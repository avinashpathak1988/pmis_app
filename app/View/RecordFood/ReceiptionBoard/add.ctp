                            ...
                            <div class="span12">
                                ...
                                <div class="form-row">
                                	...
                                	<div style="width:100%;float:right">
                                		<span class="" style="">
                                            <?php echo $this->Form->input('officer_incharge',array('div'=>false,'label'=>false,'class'=>'dotted-input','style'=>'width:20%;float: right;margin-right:20%;','type'=>'text','required'=>false,'id'=>'officer_incharge'));?>
                                    	</span>
                                	</div>
                                	<div style="width:100%;">
