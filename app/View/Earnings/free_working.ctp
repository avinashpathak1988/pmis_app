            ...
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    ...
                    <div style="float: right;">
                        <?php echo $this->Html->link('Back',array('action'=>'freeWorkingPrisoner'),array('escape'=>false,'class'=>'btn btn-success btn-mini')); ?>
...
jQuery(function($) {
    ...
    var $form = $(this);
    $('#PrisonerSavingFreeWorkingForm').validate({
        ignore: '',
            rules: { 
    ...
    $('#payGratuityBtn').click(function() {
        ...
        var is_valid = $('#PrisonerSavingFreeWorkingForm').valid();
        if(is_valid)
        {
            var payUrl = '<?php echo $payGratuityAmount;?>';
            $.post(payUrl, $('#PrisonerSavingFreeWorkingForm').serialize(), function(res) {
