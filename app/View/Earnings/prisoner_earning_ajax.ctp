    ...
    <tbody>
        ...
        foreach($datas as $data){
            ...
            <tr class="<?php if($rowCnt == count($datas)) {echo 'lastrow';}?>">
                ...
                <td>
                    <?php echo $this->Html->link($prisoner_no,array('controller'=>'earnings','action'=>'prisonerEarningDetails/'.$prisoner_uuid),array('escape'=>false,'class'=>'btn btn-success',)); ?>
                </td>
                <td><?php if(isset($prisonerData['total_working_days']))echo $prisonerData['total_working_days'];?></td>
                <td><?php if(isset($prisonerData['total_amount']))echo $prisonerData['total_amount'];?></td>
                <td><?php if(isset($prisonerData['paid_amount']))echo $prisonerData['paid_amount'];?></td>
                <td><?php if(isset($prisonerData['pending_amount']))echo $prisonerData['pending_amount'];?></td>
                <?php
                if(!isset($is_excel)){
                ?>       
                    <!-- <td> -->
