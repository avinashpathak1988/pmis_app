...
class PrisonersController extends AppController{
 ...
 function Prisonerlist($prisoner_type=''){
    ...
    function isPetition($prisoner_id)
    {
        $count = $this->Prisoner->find('count', array(
            ...
            'conditions'    => array(
                ...
                '0' => '(PrisonerSentence.sentence_of = 4 OR PrisonerSentence.sentence_of = 5)'
            )
        ));
        return $count;
    }
    ...
    */
    ...
    function getOffenceName($id='', $offence_id=''){
        $this->loadModel('PrisonerSentenceAppeal');
            $condition = array(
                'PrisonerSentenceAppeal.prisoner_id'    => $id,
                'PrisonerSentenceAppeal.offence_id IN ('.$offence_id.')'
            );
            // 'joins' => array(
            //         array(
            //         'table' => 'states',
            ...
            //         ),
            //     ), 
            $data = $this->PrisonerSentenceAppeal->find('list', array(
                'recursive'     => -1,
                'fields'        => array(
         ...
         return $data['PrisonerSentenceAppeal']['offence_id'];
    }
