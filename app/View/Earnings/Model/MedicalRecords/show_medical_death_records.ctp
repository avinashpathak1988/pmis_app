...
?>
<?php
    $exUrl = "showMedicalDeathRecords/status:$status/prisoner_id:$prisoner_id/uuid:$uuid";
    ...
    //  $execPath = $_SERVER['SERVER_NAME']."/uganda/medicalRecords/showMedicalDeathRecordspdf/status:$status/prisoner_id:$prisoner_id/uuid:$uuid";
    // $note_name = 'death_'.date('d_m_Y').'pdf';
        ...
        <tr>
            ...
            <th>
                <?php echo $this->Form->input('checkAll', array(
                      'type'=>'checkbox', 'hiddenField' => false, 'label'=>false, 'id'=>'checkAllDeath',
            ...
            ?></th>
            <th><?php                 
                echo $this->Paginator->sort('MedicalDeathRecord.prisoner_id','Date of Death',array('update'=>'#deathListingDiv','evalScripts' => true,'url'=>array('controller' => 'MedicalRecords','action' => 'showMedicalDeathRecords','status'=> $status,'prisoner_id'=> $prisoner_id,'uuid'=> $uuid)));
            ?></th>
            <th><?php                 
            ...
            ?></th>
            <th><?php                 
                echo $this->Paginator->sort('MedicalDeathRecord.prisoner_id','Place Name',array('update'=>'#deathListingDiv','evalScripts' => true,'url'=>array('controller' => 'MedicalRecords','action' => 'showMedicalDeathRecords','status'=> $status,'prisoner_id'=> $prisoner_id,'uuid'=> $uuid)));
            ?></th>
            <th><?php                 
                echo $this->Paginator->sort('MedicalDeathRecord.prisoner_id','Medical Officer',array('update'=>'#deathListingDiv','evalScripts' => true,'url'=>array('controller' => 'MedicalRecords','action' => 'showMedicalDeathRecords','status'=> $status,'prisoner_id'=> $prisoner_id,'uuid'=> $uuid)));
            ?></th>
            <th>Medical Form</th>
...
?>
        ...
        if(!isset($is_excel)){
          ...
          ?>
            <td>
            <?php
            if($this->Session->read('Auth.User.usertype_id')==Configure::read('MEDICALOFFICE_USERTYPE') && ($data['MedicalDeathRecord']['status'] == 'Draft'))
            { 
                  echo $this->Form->input('ApprovalProcess.'.$rowCnt.'.fid', array(
                      'type'=>'checkbox', 'value'=>$data['MedicalDeathRecord']['id'],'hiddenField' => false, 'label'=>false,
                      'format' => array('before', 'input', 'between', 'label', 'after', 'error' ) 
                  ));
             }
             else if($this->Session->read('Auth.User.usertype_id')==Configure::read('OFFICERINCHARGE_USERTYPE') && ($data['MedicalDeathRecord']['status'] == 'Saved'))
              {
                echo $this->Form->input('ApprovalProcess.'.$rowCnt.'.fid', array(
                      'type'=>'checkbox', 'value'=>$data['MedicalDeathRecord']['id'],'hiddenField' => false, 'label'=>false,
                      'format' => array('before', 'input', 'between', 'label', 'after', 'error' ) 
              ...
              else if($this->Session->read('Auth.User.usertype_id')==Configure::read('COMMISSIONERREHABILITATION_USERTYPE') && ($data['MedicalDeathRecord']['status'] == 'Reviewed'))
              {
                echo $this->Form->input('ApprovalProcess.'.$rowCnt.'.fid', array(
                      'type'=>'checkbox', 'value'=>$data['MedicalDeathRecord']['id'],'hiddenField' => false, 'label'=>false,
                      'format' => array('before', 'input', 'between', 'label', 'after', 'error' ) 
