    ...
    if($showOnly != 0){
         foreach($datas as $data){
                    //$convictedMales
                        ...
                        $convictedCounts = $funcall->sentenceWiseCount($data['Prison']['id'],$showOnly,$fromDate,$toDate,'Convicted'); 
                        $remandCounts = $funcall->sentenceWiseCount($data['Prison']['id'],$showOnly,$fromDate,$toDate,'Remand');
                        $debtorCounts = $funcall->sentenceWiseCount($data['Prison']['id'],$showOnly,$fromDate,$toDate,'Debtor'); ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $sentences[$showOnly] ?></td>
        ...
        <?php        
          ...
          foreach($datas as $data){
                ...
                foreach ($sentences as $key => $value) {
                        ...
                        $convictedCounts = $funcall->sentenceWiseCount($data['Prison']['id'],$key,$fromDate,$toDate,'Convicted'); 
                        $remandCounts = $funcall->sentenceWiseCount($data['Prison']['id'],$key,$fromDate,$toDate,'Remand');
                        $debtorCounts = $funcall->sentenceWiseCount($data['Prison']['id'],$key,$fromDate,$toDate,'Debtor'); ?>
