        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    <h5>Summary of Sentences of prisoners admitted from court by sex</h5>
                   ...
                   <div class="">
                    <?php echo $this->Form->create('Search',array('class'=>'form-horizontal'));?>
                        <div class="row">
                                ...
                                <div class="span6">
                                    <div class="control-group">
                                        <label class="control-label">Sentence Type:</label>
                                        <div class="controls">
                                           <?php echo $this->Form->input('sentence_id',array('div'=>false,'label'=>false,'class'=>'span11 pmis_select','type'=>'select','options'=>$sentencesList, 'empty'=>'','required'=>false,'id'=>'sentence_id'));?>
                                        </div>
                                    </div>
                                </div>
...
<?php
$ajaxUrl = $this->Html->url(array('controller'=>'PrisonerReport','action'=>'sentenceReportAjax'));
echo $this->Html->scriptBlock("
    ...
    function showData(){
        ...
        url = url + '/sentence_id:'+$('#sentence_id').val();
