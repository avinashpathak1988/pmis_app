        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    <h5>Summary of Marital Status of prisoners At arrest by sex</h5>
                        ...
                        <div class="row">
                                ...
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                           <?php echo $this->Form->input('marital_status',array('div'=>false,'label'=>false,'class'=>'span11 pmis_select','type'=>'select','options'=>$maritalStatusesList, 'empty'=>'','required'=>false,'id'=>'marital_status_id'));?>
                                        </div>
                                    </div>
                                </div>
