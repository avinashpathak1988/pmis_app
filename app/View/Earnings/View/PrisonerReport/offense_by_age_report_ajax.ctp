    ...
    if($showOnly != 0){
         foreach($datas as $data){
                    //$convictedMales
                        ...
                        $convictedCounts = $funcall->offenceWiseCount($data['Prison']['id'],$showOnly,$fromDate,$toDate,'Convicted'); 
                        $remandCounts = $funcall->offenceWiseCount($data['Prison']['id'],$showOnly,$fromDate,$toDate,'Remand');
                        $debtorCounts = $funcall->offenceWiseCount($data['Prison']['id'],$showOnly,$fromDate,$toDate,'Debtor'); ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $offenceList[$showOnly] ?></td>
        ...
        <?php        
          ...
          foreach($datas as $data){
                ...
                foreach ($offenceList as $key => $value) {
                        ...
                        $convictedCounts = $funcall->offenceWiseCount($data['Prison']['id'],$key,$fromDate,$toDate,'Convicted'); 
                        $remandCounts = $funcall->offenceWiseCount($data['Prison']['id'],$key,$fromDate,$toDate,'Remand');
                        $debtorCounts = $funcall->offenceWiseCount($data['Prison']['id'],$key,$fromDate,$toDate,'Debtor'); ?>
