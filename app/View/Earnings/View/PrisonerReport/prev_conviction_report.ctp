        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    <h5>Summary of admissons by Number of previous convictions categorized by sex separating Remand, convict, debtors.</h5>
                   ...
                   <div class="">
                    <?php echo $this->Form->create('Search',array('class'=>'form-horizontal'));?>
                        <div class="row">
                                ...
                                <div class="span6">
                                    <div class="control-group">
                                        <label class="control-label">No of times convicted:</label>
                                        <div class="controls">
                                           <?php echo $this->Form->input('times_id',array('div'=>false,'label'=>false,'class'=>'span11 pmis_select','type'=>'select','options'=>$timesList, 'empty'=>'','required'=>false,'id'=>'times_id'));?>
                                        </div>
                                    </div>
                                </div>
...
<?php
$ajaxUrl = $this->Html->url(array('controller'=>'PrisonerReport','action'=>'prevConvictionReportAjax'));
