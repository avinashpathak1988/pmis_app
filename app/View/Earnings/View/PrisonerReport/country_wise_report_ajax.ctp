    ...
    if($showOnly != 0){
         foreach($datas as $data){
                    //$convictedMales
                        ...
                        $convictedCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$showOnly,'Country',$fromDate,$toDate,'Convicted'); 
                        $remandCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$showOnly,'Country',$fromDate,$toDate,'Remand');
                        $debtorCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$showOnly,'Country',$fromDate,$toDate,'Debtor'); ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $countriesList[$showOnly] ?></td>
        ...
        <?php        
          ...
          foreach($datas as $data){
                ...
                foreach ($countriesList as $key => $value) {
                        ...
                        $convictedCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$key,'Country',$fromDate,$toDate,'Convicted'); 
                        $remandCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$key,'Country',$fromDate,$toDate,'Remand');
                        $debtorCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$key,'Country',$fromDate,$toDate,'Debtor'); 
                     ?>
