...
<?php
    $this->Paginator->options(array(
        ...
        //'complete'                    => '$("#lodding_image").hide();',
            ...
            'action'                    => 'prevConvictionReportAjax',
...
<?php
   ...
   $exUrl = "prevConvictionReportAjax";
...
<table id="districtTable" class="table table-bordered table-striped table-responsive">
    <thead>
        <tr>
            ...
            <th>Prison</th>
            <th>Number of previous convictions</th>
    ...
    if($showOnly != 0){
         foreach($datas as $data){
                    //$convictedMales
                        ...
                        $convictedCounts = $funcall->convictionWiseCount($data['Prison']['id'],$showOnly,$fromDate,$toDate,'Convicted'); 
                        $remandCounts = $funcall->convictionWiseCount($data['Prison']['id'],$showOnly,$fromDate,$toDate,'Remand'); 
                        $debtorCounts = $funcall->convictionWiseCount($data['Prison']['id'],$showOnly,$fromDate,$toDate,'Debtor');  
                        ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $timesList[$showOnly] ?></td>
        ...
        <?php        
          ...
          foreach($datas as $data){
                ...
                foreach ($timesList as $key => $value) {



                        $convictedCounts = $funcall->convictionWiseCount($data['Prison']['id'],$key,$fromDate,$toDate,'Convicted'); 
                        $remandCounts = $funcall->convictionWiseCount($data['Prison']['id'],$key,$fromDate,$toDate,'Remand'); 
                        $debtorCounts = $funcall->convictionWiseCount($data['Prison']['id'],$key,$fromDate,$toDate,'Debtor'); 
                        ?>
