...
<?php
    $this->Paginator->options(array(
        ...
        //'complete'                    => '$("#lodding_image").hide();',
            ...
            'action'                    => 'maritalStatusReportAjax',
    ...
    if($showOnly != 0){
         foreach($datas as $data){
                    //$convictedMales
                        ...
                        $convictedCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$showOnly,'MaritalStatus',$fromDate,$toDate,'Convicted'); 
                        $remandCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$showOnly,'MaritalStatus',$fromDate,$toDate,'Remand');
                        $debtorCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$showOnly,'MaritalStatus',$fromDate,$toDate,'Debtor');
                         ?>
                    <tr>
                        ...
                        <td><?php echo $maritalStatuses[$showOnly] ?></td>
        ...
        <?php        
          ...
          foreach($datas as $data){
                ...
                foreach ($maritalStatuses as $key => $value) {
                        ...
                        $convictedCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$key,'MaritalStatus',$fromDate,$toDate,'Convicted'); 
                        $remandCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$key,'MaritalStatus',$fromDate,$toDate,'Remand');
                        $debtorCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$key,'MaritalStatus',$fromDate,$toDate,'Debtor'); 
                        ?>
                    <tr>
                        <td><?php echo $rowcnt; ?></td>
                        <td></td>
