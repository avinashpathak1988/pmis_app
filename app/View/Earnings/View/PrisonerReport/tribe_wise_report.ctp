        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    <h5>Summary of admissons by Tribes of uganda (Ugandan only) Categorized by Sex</h5>
                        ...
                        <div class="row">
                                ...
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                           <?php echo $this->Form->input('tribe_id',array('div'=>false,'label'=>false,'class'=>'span11 pmis_select','type'=>'select','options'=>$tribesList, 'empty'=>'','required'=>false,'id'=>'tribe_id'));?>
                                        </div>
                                    </div>
                                </div>
...
<?php
$ajaxUrl = $this->Html->url(array('controller'=>'PrisonerReport','action'=>'tribeWiseReportAjax'));
