                        ...
                        <div class="row">
                                ...
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                         <?php echo $this->Form->input('prisoner_id',array('div'=>false,'label'=>false,'class'=>'form-control','type'=>'select','options'=>array(), 'empty'=>array(''=>''),'required'=>false));?>
                                        </div>
                                    </div>
                                </div>
                                <div class="span6">
...
echo $this->Html->scriptBlock("
    ...
    function showData(){
        ...
        url = url + '/prisoner_id:'+$('#SearchPrisonerId').val();
