...
?>
<?php
                $a = date(configure::read('UGANDA-DATE-FORMAT'),strtotime($data['Prisoner']['dor']));
                $b=date('d-m-Y');
                 $diff=strtotime($a)-strtotime($b);
                 $temp='';
                 if ($a != '01-01-1970'){
                 $temp=round($diff/86400);
                 }
                ...
                ?>
        <tr>        
            <td style='background-color: <?php echo $color; ?>;'><?php echo $rowCnt; ?></td>
            <td style='background-color: <?php echo $color; ?>;'><?php echo $data["Prisoner"]["prisoner_no"]?> </td>
            <td style='background-color: <?php echo $color; ?>;'><?php echo $data["Prisoner"]["fullname"]; ?>  </td> 
