...
?>
        <tr>
            ...
            <td><?php echo (isset($data["InPrisonPunishment"]["punishment_start_date"]) && $data["InPrisonPunishment"]["punishment_start_date"]!='') ? date("d-m-Y",strtotime($data["InPrisonPunishment"]["punishment_start_date"])) : ''; ?></td>
            <td><?php echo (isset($data["InPrisonPunishment"]["punishment_end_date"]) && $data["InPrisonPunishment"]["punishment_end_date"]!='') ? date("d-m-Y",strtotime($data["InPrisonPunishment"]["punishment_end_date"])) : ''; ?></td>
            ...
            <td>
                ...
                if(isset($data["InPrisonPunishment"]["privilege_id"]) && $data["InPrisonPunishment"]["privilege_id"]!=''){
                    ...
                    foreach (explode(",", $data["InPrisonPunishment"]["privilege_id"]) as $key => $value) {
                        $privilage[] = $funcall->getName($value,"Privilege","name");
                    }
...
?>              
            <!-- <td>
              <?php
                // echo $data['InPrisonOffenceCapture']['status'];
