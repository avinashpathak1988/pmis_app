...
<table id="districtTable" class="table table-bordered table-striped table-responsive">
  <thead>
    <tr>
      ...
      <th>
        <?php                 
        echo $this->Paginator->sort('EarningRateHistory.rate_val','rate_val',array('update'=>'#listingDiv','evalScripts' => true,
          'url'=>array(
            'controller' => 'EarningRates',
            'action' => 'historyAjax', 
            'prison_id'      => $prison_id,
...
?>
    <tr>
      ...
      <td><?php echo ucwords(h($data['EarningRateHistory']['rate_val'])); ?>&nbsp;</td>
      <td><?php echo date(Configure::read('UGANDA-DATE-FORMAT'),strtotime($data['EarningRateHistory']['start_date'])); ?>&nbsp;</td> 
      <td><?php echo date(Configure::read('UGANDA-DATE-FORMAT'),strtotime($data['EarningRateHistory']['end_date'])); ?>&nbsp;</td>
