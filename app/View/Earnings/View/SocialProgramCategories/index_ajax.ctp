...
<?php
    $this->Paginator->options(array(
        ...
        'url'                       => array(
            'controller'            => 'SocialProgramCategories',
            'action'                => 'indexAjax',
            'id'                    =>  $id,
            //'from_date'             => $from_date,
            //'to_date'               => $to_date,
...
<table class="table table-bordered data-table table-responsive">
    <thead>
        <tr>
            ...
            <th>
            <?php                 
          echo $this->Paginator->sort('SocialProgramCategory.name','Name',array('update'=>'#listingDiv','evalScripts' => true,'url'=>array('controller' => 'SocialProgramCategories','action' => 'indexAjax')));
          ?></th>
            <th>
            <?php                 
          echo $this->Paginator->sort('SocialProgramCategory.is_enable','Is Enable',array('update'=>'#listingDiv','evalScripts' => true,'url'=>array('controller' => 'SocialProgramCategories','action' => 'indexAjax')));
          ?></th>
...
?>
        <tr>
           ...
           <td><?php
                if($data['SocialProgramCategory']['is_enable'] == 1){
...
?>
            ...
            <td>
                ...
                <?php echo $this->Form->create('SocialProgramCategoryEdit',array('url'=>'/SocialProgramCategories/add','admin'=>false));?> 
                <?php echo $this->Form->input('id',array('type'=>'hidden','value'=> $data['SocialProgramCategory']['id'])); ?>
                ...
                <?php echo $this->Form->create('SocialProgramCategoryDelete',array('url'=>'/SocialProgramCategories/index','admin'=>false));?> 
                <?php echo $this->Form->input('id',array('type'=>'hidden','value'=> $data['SocialProgramCategory']['id'])); ?>
