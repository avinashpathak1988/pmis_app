<section class="content">
	<div class="box box-primary">
        ...
        <?php echo $this->Html->link(__('Biometric List'), array('action' => 'index'),array('class' => 'btn btn-primary')); ?>
    </div>
          <h3 class="box-title">Add New Biometric</h3>
        </div><!-- /.box-header -->
                          
      	<div class="box-body">
      		<?php echo $this->Form->create('BiometricMap'); ?>  
