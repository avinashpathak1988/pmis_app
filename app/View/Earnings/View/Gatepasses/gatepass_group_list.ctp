                            ...
                            <div class="row" style="padding-bottom: 14px;">
                                ...
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <?php echo $this->Form->input('gatepass_type',array('div'=>false,'label'=>false,'type'=>'select','empty'=>'','options'=>$gatepassType, 'class'=>'form-control pmis_select', 'id'=>'gatepass_type'));?>
                                        </div>
                                    </div>
                                </div>
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <?php echo $this->Form->input('gatepass_status',array('div'=>false,'label'=>false,'type'=>'select','empty'=>'','options'=>array("Created"=>"Created","OUT"=>"OUT","IN"=>"IN"), 'class'=>'form-control pmis_select', 'id'=>'gatepass_status'));?>
                                        </div>
                                    </div>
                                </div>
                                <div class="span6" style="display:<?php echo ($this->Session->read('Auth.User.usertype_id')==Configure::read("OFFICERINCHARGE_USERTYPE")) ? 'block': 'none'; ?>">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            echo $this->Form->input('status',array('div'=>false,'label'=>false,'type'=>'select','empty'=>'-- All --','options'=>array("Draft"=>"Draft","Approved"=>"Approved"), 'class'=>'form-control', 'id'=>'status',"required"=>false)+$defaultSearch);?>
                                        </div>
                                    </div>
                                </div>
                                <div class="span6" style="display:<?php echo ($this->Session->read('Auth.User.usertype_id')==Configure::read("MAIN_GATEKEEPER_USERTYPE")) ? 'block': 'none'; ?>">
                                    <div class="control-group">
                                        <label class="control-label">Status</label>
                                        <div class="controls">
                                            <?php
                                            ...
                                            if($this->Session->read('Auth.User.usertype_id')==Configure::read("MAIN_GATEKEEPER_USERTYPE")){
                                                $defaultSearch = array("default"=>0);
                                            }
                                            echo $this->Form->input('verify_status',array('div'=>false,'label'=>false,'type'=>'select','empty'=>'-- All --','options'=>array(0=>"Not Verify",1=>"Verify"), 'class'=>'form-control', 'id'=>'verify_status',"required"=>false)+$defaultSearch);?>
                                        </div>
                                    </div>
                                </div>
                                <?php /* ?>
...
$ajaxUrl            = $this->Html->url(array('controller'=>'Gatepasses','action'=>'gatepassGroupListAjax'));
...
echo $this->Html->scriptBlock("
    ...
    function showData(){
        ...
        url = url + '/is_verify:'+$('#verify_status').val();
        // url = url + '/status:'+$('#status').val();
        $.post(url, {}, function(res) {
            $('#listingDiv').html(res);
