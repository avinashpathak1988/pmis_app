    ...
    <tbody>
        ...
        foreach($datas as $data){
            ...
            <tr class="<?php if($rowCnt == count($datas)) {echo 'lastrow';}?>">
                ...
                <td>
                    <?php echo $data['Prisoner']['fullname']; ?>
                </td>
                <td>
                    <?php echo $prisoner_no; ?>
                </td>
                <td><?php echo $data['WorkingParty']['name']; ?></td>
                <td><?php echo $data['PrisonerAttendance']['attendance_date']; ?></td>
                <td><?php echo $data['PrisonerAttendance']['is_present']; ?></td>
                <?php
                if(!isset($is_excel)){
                ?>       
                    <!-- <td> -->
