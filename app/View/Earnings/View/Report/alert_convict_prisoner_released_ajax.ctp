...
<?php
    $this->Paginator->options(array(
        ...
        'url'                       => array(
            'controller'            => 'Report',
            'action'                => 'alertConvictPrisonerReleasedAjax',
            'name'             => $name,
            'state_id'		   => $state_id,
...
?>
<?php
    $exUrl = "alertConvictPrisonerReleasedAjax/name:$name";
...
<table class="table table-bordered table-striped table-responsive">
	<thead>
		<tr>
			...
			<th>Prisoner Name</th>
			<th>Gender</th>
			<!-- <th>Geographical district of Station</th> -->
			<th>Desired geographical district of release</th>
...
<?php $count++; ?>
	<tr>
			...
			<!-- <td><?php echo $funcall->getName($PrisonerVal['Prison']['geographical_id'],'GeographicalDistrict','name');?></td>	 -->		
			<td><?php echo $PrisonerVal['Prisoner']['desired_districts_relese'];?></td>
