        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    <h5>Summary of Offence-category by Sex</h5>
                        ...
                        <div class="row" style="padding-bottom: 14px;">
                            <div class="span4">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php echo $this->Form->input('offence_id',array('div'=>false,'label'=>false,'type'=>'select','empty'=>'-- Select Offence --','options'=>$offenceList, 'class'=>'form-control', 'id'=>'offence_id'));?>
                                    </div>
                                </div>
                            </div>
                            <div class="span4">
...
<?php
$ajaxUrl        = $this->Html->url(array('controller'=>'report','action'=>'offenceAndAgeGroupAjax'));
