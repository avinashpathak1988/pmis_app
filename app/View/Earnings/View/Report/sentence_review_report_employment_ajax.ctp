...
<?php
    $this->Paginator->options(array(
        ...
        'url'                       => array(
            'controller'            => 'Report',
            'action'                => 'sentenceReviewReportEmploymentAjax',
            'name'             		=> $name,
            'state_id'		   		=> $state_id,
...
?>
<?php
    $exUrl = "sentenceReviewReportEmploymentAjax/name:$name";
...
<?php $count++; ?>
	<tr>
			...
			<td><?php echo $PrisonerVal['PrisonerCaseFile']['court_file_no'];?></td>	
			<td><?php echo $funcall->getName($PrisonerVal['PrisonerOffence']['offence'],'Offence','name'); ?></td>
			<td><?php echo $PrisonerVal['Employment']['name'];?></td>	
