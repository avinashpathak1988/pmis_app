        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    <h5>Summary of Remands-category by Sex</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="span3">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php echo $this->Form->input('gender_id',array('div'=>false,'label'=>false,'type'=>'select','empty'=>'-- Select Gender --','options'=>$genderList, 'class'=>'form-control', 'id'=>'gender_id'));?>
                                    </div>
                                </div>
                            </div>                            
                            <div class="span3">
...
<?php
$ajaxUrl        = $this->Html->url(array('controller'=>'report','action'=>'admissionsSummaryAjax'));
