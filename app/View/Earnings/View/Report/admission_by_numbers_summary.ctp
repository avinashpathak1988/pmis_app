        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    <h5>Summary of admissions by numbers of previous convictions categorized by sex(separating convicts and remands)</h5>
...
<?php
$ajaxUrl        = $this->Html->url(array('controller'=>'report','action'=>'admissionByNumbersSummaryAjax'));
