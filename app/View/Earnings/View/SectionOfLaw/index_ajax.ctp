...
<table id="districtTable" class="table table-bordered table-striped table-responsive">
  <thead>
    <tr>
      ...
      <th>
        <?php                 
          echo $this->Paginator->sort('SectionOfLaw.name','SectionOfLaw',array('update'=>'#listingDiv','evalScripts' => true,'url'=>array('controller' => 'SectionOfLaw','action' => 'indexAjax')));
          ?>
      </th>
      <th><?php                 
          echo $this->Paginator->sort('Offence.name','Offence',array('update'=>'#listingDiv','evalScripts' => true,'url'=>array('controller' => 'SectionOfLaw','action' => 'indexAjax')));
          ?>
          </th>
...
?>
    <tr>
      ...
      <td><?php if($laws['SectionOfLaw']['name']!='')echo ucwords(h($laws['SectionOfLaw']['name']));else echo Configure::read('NA'); ?>&nbsp;</td>    
      <td><?php if($laws['Offence']['name']!='')echo ucwords(h($laws['Offence']['name']));else echo Configure::read('NA'); ?>&nbsp;</td>  				
