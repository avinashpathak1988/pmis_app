        ...
        {  
            ...
            <tr class="<?php if($rowCnt == count($datas)) {echo 'lastrow';}?>">
                ...
                <td>
                    ...
                    {
                        echo $this->Html->link('Re-admit','/prisoners/add/'.$prisoner_unique_no,array('escape'=>false,'class'=>'btn btn-success btn-mini pull-right','title'=>'Re admission'));
                    }
                    else if($data["Prisoner"]["is_final_save"] == 0 && $data['Prisoner']['present_status'] == 1)
                    {
                        echo $this->Html->link('<i class="icon icon-trash" ></i>','javascript:void(0);',array('escape'=>false,'class'=>'btn btn-danger pull-right','title'=>'Delete','onclick'=>"javascript:trashPrisoner('$uuid');"));
                    }?>
                  </td>
            </tr>
            <?php $rowCnt++;
