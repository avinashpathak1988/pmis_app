                ...
                <div class="widget-content nopadding">
                    ...
                    <div class="row" style="padding-bottom: 14px;">
                        ...
                        <div class="span12 add-top" align="center" valign="center">
                            ...
                            <?php echo $this->Form->input('Reset', array('type'=>'reset', 'div'=>false,'label'=>false, 'class'=>'btn btn-danger', 'onclick'=>"resetData('SearchListviewForm')"))?>
                        </div>                        
                    </div> 
                    <?php echo $this->Form->end();?> 
...
<?php
$ajaxUrl            = $this->Html->url(array('controller'=>'prisoners','action'=>'listAjax'));
...
echo $this->Html->scriptBlock("
    ...
    $(document).ready(function(){
        ...
        $('#SearchListviewForm').submit(function(event) { 
            showData();
