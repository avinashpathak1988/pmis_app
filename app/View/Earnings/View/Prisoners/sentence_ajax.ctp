...
?>
        <tr>
            ...
            <td><?php echo $data['Prisoner']['uuid']; ?></td>
            <td><?php echo 'Sentence-'.$data['PrisonerSentence']['id']; ?></td>
...
?>          <td>    
            <table>
                <tr>
                    <td>
                        <?php echo $this->Form->create('PrisonerDataEdit',array('url'=>'/Prisoners/edit/'.$puuid.'#sentence_capture','admin'=>false));?> 
                      ...
                      <td>
                           <?php echo $this->Form->button('Delete', array('type'=>'button', 'div'=>false, 'label'=>false, 'class'=>'btn btn-danger', 'onclick'=>"javascript:deleteSentence('$id');"))?>
                    </td>
                    <td>
