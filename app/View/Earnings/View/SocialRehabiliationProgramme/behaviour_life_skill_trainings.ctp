        ...
        <div class="span12">
            ...
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    <h5>Behaviour Life skills  Training</h5>
                    <div style="float:right;padding-top: 7px;">
                        <?php echo $this->Html->link(__('Add New'), array('action' => 'addBehaviourLifeSkillTrainings'), array('escape'=>false,'class'=>'btn btn-success btn-mini')); ?>
                        &nbsp;&nbsp;
                    </div>
                </div>
                ...
                <div class="widget-content nopadding">
                    ...
                    <?php echo $this->Form->create('Search',array('class'=>'form-horizontal'));?>
                        <div id="searchPrisonerTwo" class="row collapse" style="height:auto;">
                          ...
                          <div class="span12 add-top" align="center" valign="center">
                                ...
                                <?php echo $this->Form->input('Reset', array('type'=>'reset', 'div'=>false,'label'=>false, 'class'=>'btn btn-danger', 'onclick'=>"resetData('SearchBehaviourLifeSkillTrainingsForm')"))?>
                            </div> 
                    </div> 
                                <?php echo $this->Form->end();?>
                    </div>
                    <div id="BehaviourLifeSkillTrainingList"></div>
                    <div id="addHeadRemarkModal" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <?php echo $this->Form->input('id',array('div'=>false,'label'=>false,'class'=>'form-control ','id'=>'behaviour_id','type'=>'hidden'));?>
...
$ajaxUrlBehaviouLifeSkillTrainingList = $this->Html->url(array('controller'=>'SocialRehabiliationProgramme','action'=>'behaviouLifeSkillTrainingAjax'));
...
<script type="text/javascript">
    ...
    $( document ).ready(function() {
            ...
            var url ='<?php echo $ajaxUrlBehaviouLifeSkillTrainingList?>';
            $.post(url,{},function(res) {
                if (res) {
                    $('#BehaviourLifeSkillTrainingList').html(res);
                    
                 }else{
                    
                    $('#BehaviourLifeSkillTrainingList').html('No records found !');
    ...
    function showListSearch(){
        ...
        var url ='<?php echo $ajaxUrlBehaviouLifeSkillTrainingList?>';
        $.post(url, $('#SearchBehaviourLifeSkillTrainingsForm').serialize(), function(res) {
            if (res) {
                        $('#BehaviourLifeSkillTrainingList').html(res);
                 }else{
                        $('#BehaviourLifeSkillTrainingList').html('No records found !');
 ...
 function finalSave(id){
        ...
        $.post(url,{'id':id,'model':'BehaviourLifeSkillTraining'}, function(res) {
                if (res == 'success') {
...
function submitHeadRemark(){
    var url ='<?php echo $ajaxUrlsubmitHeadRemark?>';
        $.post(url,$('#BehaviourLifeSkillTrainingBehaviourLifeSkillTrainingsForm').serialize(), function(res) {
                if (res == 'success') {
                    //dynamicAlertBox('Message', 'continued successfully !');
                    location.reload();
                }else{
