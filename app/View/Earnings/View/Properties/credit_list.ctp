                        ...
                        <div class="row" style="padding-bottom: 14px;">
                            <div class="span6">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                       <?php echo $this->Form->input('currency',array('div'=>false,'label'=>false,'class'=>'span11 pmis_select','type'=>'select','options'=>$currencyList, 'empty'=>'','required'=>false,'id'=>'status','default'=>$default_status));?>
                                    </div>
                                </div>
                            </div>
                            <div class="span6">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php echo $this->Form->input('date_from',array('div'=>false,'label'=>false,'class'=>'form-control span11 date_from mydate','type'=>'text','placeholder'=>'Start Date','id'=>'date_from',"readonly"=>true, 'style'=>'width:43%;'));?>
                                        To
                                        <?php echo $this->Form->input('date_to',array('div'=>false,'label'=>false,'class'=>'form-control span11 date_to mydate','type'=>'text','placeholder'=>'End Date','id'=>'date_to',"readonly"=>true, 'style'=>'width:43%;'));?>
                                    </div>
                                </div>
                                <!-- <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                       <?php echo $this->Form->input('status',array('div'=>false,'label'=>false,'class'=>'','type'=>'select','options'=>$statusList, 'empty'=>'','required'=>false,'id'=>'status','default'=>$default_status));?>
                                    </div>
                                </div>
                            </div>
