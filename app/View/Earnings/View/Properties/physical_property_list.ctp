        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    <h5>Prisoner Physical Property List</h5>
                ...
                <div class="widget-content nopadding">
                            ...
                            <div class="span6">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls phy-prop-dt">
                                        <?php echo $this->Form->input('date_from',array('div'=>false,'label'=>false,'class'=>'form-control span11 from_date mydate','type'=>'text','placeholder'=>'Start Date','id'=>'date_from',"readonly"=>true, ));?>
                                        To
                                        <?php echo $this->Form->input('date_to',array('div'=>false,'label'=>false,'class'=>'form-control span11 to_date mydate','type'=>'text','placeholder'=>'End Date','id'=>'date_to',"readonly"=>true,));?>
                                    </div>
                                </div>
                            </div>
                   ...
                   <!--  property view modal  -->
                     ...
                     <div class="modal fade" id="propertyView" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                 
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Property Items Detail</h5> 
...
<?php
$ajaxUrlItem = $this->Html->url(array('controller'=>'properties','action'=>'physicalPropertyAjax'));
...
function showData(){       
    ...
    $.post(url, $('#SearchPhysicalPropertyListForm').serialize(), function(res) {
        if (res) {
            $('#dataList').html(res);
            //show Check Box
            showCheckBox();
