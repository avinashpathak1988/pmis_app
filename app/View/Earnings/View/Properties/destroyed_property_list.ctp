        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    <h5>Prisoner Destroyed Property List</h5>
                ...
                <div class="widget-content nopadding">
                    <div class="collapse" style="height: 0px;" id="searchBox">
                        ...
                        <div class="row destroy-prop-li" style="padding-bottom: 14px;">
                            <div class="span6">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                       <?php echo $this->Form->input('item_id',array('div'=>false,'label'=>false,'class'=>'form-control span11','type'=>'select','options'=>$propertyItemList, 'empty'=>'-- Select Property Item --','required'=>false,'id'=>'item_id'));?>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                       ...
                                       echo $this->Form->input('property_type',array('div'=>false,'label'=>false,'class'=>'form-control span11','type'=>'select','options'=>$property_typeList, 'empty'=>'-- Select Property Type --','required'=>false,'id'=>'property_type'));?>
                                    </div>
                                </div>
                            </div>
                            <div class="span6">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                       <?php 
                                       echo $this->Form->input('status',array('div'=>false,'label'=>false,'type'=>'select','empty'=>'-- Select Prisnors --','options'=>$sttusListData, 'class'=>'form-control','required', 'id'=>'status','default'=>$default_status));?>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Date :</label>
                                    <div class="controls">
                                        <?php echo $this->Form->input('date_from',array('div'=>false,'label'=>false,'class'=>'form-control span11 from_date mydate','type'=>'text','placeholder'=>'Start Date','id'=>'date_from',"readonly"=>true, 'style'=>'width:43%;'));?>
                                        To
                                        <?php echo $this->Form->input('date_to',array('div'=>false,'label'=>false,'class'=>'form-control span11 to_date mydate','type'=>'text','placeholder'=>'End Date','id'=>'date_to',"readonly"=>true, 'style'=>'width:43%;'));?>
                                    </div>
                                </div>
                            </div>
...
<?php
$ajaxUrlItem = $this->Html->url(array('controller'=>'properties','action'=>'destroyedPropertyListAjax'));
...
function showData(){       
    ...
    $.post(url, $('#SearchDestroyedPropertyListForm').serialize(), function(res) {
        if (res) {
            $('#dataList').html(res);
            //show Check Box
            showCheckBox();
