...
<?php
    $this->Paginator->options(array(
        ...
        'url'                       => array(
            'controller'            => 'SocialProgramLevels',
            'action'                => 'indexAjax',
            'id'                    =>  $id,
            //'from_date'             => $from_date,
            //'to_date'               => $to_date,
...
<table class="table table-bordered data-table table-responsive">
    <thead>
        <tr>
            ...
            <th>
            <?php                 
          echo $this->Paginator->sort('SocialProgramLevel.name','Name',array('update'=>'#listingDiv','evalScripts' => true,'url'=>array('controller' => 'SocialProgramLevels','action' => 'indexAjax')));
          ?></th>
            <th>
            <?php                 
          echo $this->Paginator->sort('SocialProgramLevel.is_enable','Is Enable',array('update'=>'#listingDiv','evalScripts' => true,'url'=>array('controller' => 'SocialProgramLevels','action' => 'indexAjax')));
          ?></th>
...
?>
        <tr>
            ...
            <td><?php
                if($data['SocialProgramLevel']['is_enable'] == 1){
...
?>
            ...
            <td>
                ...
                <?php echo $this->Form->create('SocialProgramLevelEdit',array('url'=>'/SocialProgramLevels/add','admin'=>false));?> 
                <?php echo $this->Form->input('id',array('type'=>'hidden','value'=> $data['SocialProgramLevel']['id'])); ?>
                ...
                <?php echo $this->Form->create('SocialProgramLevelDelete',array('url'=>'/SocialProgramLevels/index','admin'=>false));?> 
                <?php echo $this->Form->input('id',array('type'=>'hidden','value'=> $data['SocialProgramLevel']['id'])); ?>
