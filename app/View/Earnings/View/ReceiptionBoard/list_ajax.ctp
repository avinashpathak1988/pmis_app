<?php if(is_array($welfareDetailsList) && count($welfareDetailsList)>0){
    if(!isset($is_excel)){
?>
<div class="span5">
...
echo $this->Form->create('ApprovalProcessForm',array('class'=>'form-horizontal','enctype'=>'multipart/form-data','url' => '/ReceiptionBoard/'));?>
<?php if($isModal == 1)
{?>
  <!-- Verify Modal START -->
...
<table class="table table-bordered data-table" id="cashidtbl">
    ...
    <tbody>
        ...
        foreach($welfareDetailsList as $data){
      ...
      <tr>
        <td>
          ...
          <td><?php echo $data['WelfareDetail']['prisoner_number']; ?></td>
          <td><?php echo $data['WelfareDetail']['prisoner_name']; ?></td>
          <td><?php echo $data['WelfareDetail']['officer_incharge']; ?></td>
          <td><?php if ($data['WelfareDetail']['status']=='Saved') {
           echo "Forwaded";
          } else{echo $data['WelfareDetail']['status'];} ?></td>
          <td><?php echo $this->Html->link("View",array(
                    'controller'=>'ReceiptionBoard',
                    'action'=>'viewReport',
                    $data['WelfareDetail']['prisoner_id']
                  ),array(
