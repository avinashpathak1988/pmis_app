        ...
        <div class="span12">
            ...
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    <h5>Discharge Board Summary</h5>
                    <div style="float:right;padding-top: 7px;">
                        <?php echo $this->Html->link(__('Add New'), array('action' => 'addSelectPrisoner'), array('escape'=>false,'class'=>'btn btn-success btn-mini')); ?>
                        &nbsp;&nbsp;
                    </div>
                </div>
                      ...
                      <div class="row-fluid">
                         <div class="span12">
                        <div class="dischargeSummaryList" id="dischargeSummaryList">
...
<?php
$ajaxUrlDischargeSummaryList = $this->Html->url(array('controller'=>'DischargeBoardSummary','action'=>'dischargeSummaryAjax'));
