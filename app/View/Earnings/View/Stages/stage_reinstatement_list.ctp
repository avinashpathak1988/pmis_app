                            ...
                            <div class="row" style="padding-bottom: 14px;">
                                ...
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <?php echo $this->Form->input('status',array('div'=>false,'label'=>false,'type'=>'select','empty'=>'-- Select Prisnors --','options'=>$sttusListData, 'class'=>'form-control','required', 'id'=>'status','default'=>'Draft'));?>
                                        </div>
                                    </div>
                                </div>
...
<?php
$ajaxUrl        = $this->Html->url(array('controller'=>'Stages','action'=>'stagereinstatementListAjax'));
