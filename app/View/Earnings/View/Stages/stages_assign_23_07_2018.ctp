                        ...
                        <div class="tabscontent">
                            ...
                            <div id="stagePromotion">
                                    ...
                                    <div class="row" style="padding-bottom: 14px;">
                                      <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <?php echo $this->Form->input('promotion_date',array('div'=>false,'label'=>false,'class'=>'form-control mydate span11','type'=>'text', 'placeholder'=>'Enter Date of Promotion','required','readonly'=>'readonly','id'=>'promotion_date','value'=>date('d-m-Y')));?>
                                                </div>
                                            </div>
                                        </div>                             
                                        <div class="span6">
                                    ...
                                    <div class="form-actions" align="center">
                                        <?php echo $this->Form->button('Add To Promotion List', array('type'=>'submit', 'div'=>false,'label'=>false, 'class'=>'btn btn-success', 'formnovalidate'=>true))?>
                                    </div>
