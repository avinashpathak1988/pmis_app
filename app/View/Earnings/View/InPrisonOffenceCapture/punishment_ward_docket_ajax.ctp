...
?>
        <tr>        
            ...
            <td><?php echo date(Configure::read('UGANDA-DATE-FORMAT'), strtotime($data["InPrisonPunishment"]["punishment_end_date"])) ;?></td>
                ...
                <td><?php echo $data["InPrisonPunishment"]["full_diet"]; ?>  </td>
                <td>
                    <?php 
                     echo $this->Html->link('PF89',array(
                            'action'=>'../InPrisonOffenceCapture/discplinaryPdfDownload',
                            $data['DisciplinaryProceeding']['prisoner_id']
                        ),array(
                            'escape'=>false,
