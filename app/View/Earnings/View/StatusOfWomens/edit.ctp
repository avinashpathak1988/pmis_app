<?php
echo $this->Html->link('Manage Status Of Women',array(
  'action'=>'index'
));
 ?>
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="col-md-7">
      <?php echo $this->Form->create('StatusOfWomen'); ?>
          <div class="box-body">
            <div class="form-group">
              <div class="row">
                <label class="col-sm-4 col-md-3 lableTopMar">Status Of Women  <font style='color:red'>*</font></label>
                <div class="col-sm-5 col-md-6">
                  <?php
                    ...
                    echo $this->Form->input('name',array(
                      'div'=>false,
                      'label'=>false,
                      'placeholder'=>'Enter Status Of Women',
                      'class'=>'form-control',
                      'required'
                    ));
                   ?>
