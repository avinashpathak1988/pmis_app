        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row" style="padding-bottom: 14px;">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls uradioBtn">
                                ...
                                if($this->Session->read('Auth.User.usertype_id')==$user_type1){
                                    $verification_type = array('Saved'=>'Saved');
                                    $default = array("default"=>"Saved");
                                }
                    ...
                    <div class="control-group">
                        <label class="control-label">Destruction Cause <span id="isRemarkValidate" style="display:none;"><?php echo $req; ?></span>:</label>
                        <div class="controls uradioBtn">
                           <?php echo $this->Form->input('PhysicalPropertyItem.destroy_cause',array('div'=>false,'label'=>false,'class'=>'form-control span11','type'=>'textarea','placeholder'=>'Enter Cause','id'=>'remark','rows'=>3,'required'=>false));?>
                           <div style="clear:both;"></div>
                            <div class="error-message" id="verification_message_err" style="display:none;">Verification type is required !</div>
                        </div>
                    </div> 
                    <?php if($this->Session->read('Auth.User.usertype_id')==$user_type1){?>
                     <div class="control-group">
                        <label class="control-label">Prohibited property <span id="isRemarkValidate" style="display:none;"><?php echo $req; ?></span>:</label>
                        <div class="controls uradioBtn">
                           <?php 
                           $Prohibited = array('Prohibited'=>'Prohibited items');
                           echo $this->Form->radio('PhysicalPropertyItem.is_provided', $Prohibited,array("legend"=>false,'class'=>'verification_type radio','readonly','default'=>'Prohibited')); ?>
                           <div style="clear:both;"></div>
                            <div class="error-message" id="verification_message_err" style="display:none;">Verification type is required !</div>
                        </div>
                    </div> 
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <?php 
                            $nokList=array('Destroyed' => 'Destroyed');
                            echo $this->Form->input('PhysicalPropertyItem.property_type',array('div'=>false,'label'=>false,'class'=>'form-control pmis_select','type'=>'select','options'=>$nokList, 'empty'=>'-- Select property type --','default'=>'Destroy','readonly','required'=>true));?>
                        </div>
                    </div>  
                    <div class="control-group ">
                    ...
                    <div class="control-group ">
                            ...
                            <?php echo $this->Form->input('PhysicalPropertyItem.destroy_date',array('div'=>false,'label'=>false,'class'=>'form-control span11','type'=>'text', 'placeholder'=>'Enter Date Time','required','readonly'=>'readonly','id'=>'destroy_date','value'=>$property_date_time));?>
                            </div>
                    </div> 
                    <div class="control-group " >
                    ...
                    <div class="control-group " >
                        ...
                        <div class="controls">
                           <?php echo $this->Form->input('PhysicalPropertyItem.destruction_mode',array('div'=>false,'label'=>false,'class'=>'form-control span11','type'=>'text','placeholder'=>'Enter Mode of Destruction','id'=>'destruction_mode','rows'=>3,'required'=>false));?>
                        </div>
                    </div>
                    <?php }?>
                    </div>
