                        ...
                        <div class="span12 case_list <?php echo $disableFieldClass;?>" id="<?php echo $c;?>_case_file" style="background:#fff;border-top:1px solid #ddd;border-bottom:1px solid #ddd;box-shadow:0 0 5px #ddd;border-left:5px solid #a03230;margin:10px 0px; position:relative; padding-bottom: 10px;">
                            ...
                            <div class="span6">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php echo $this->Form->input('PrisonerCaseFile.'.$c.'.court_file_no',array('div'=>false,'label'=>false,'class'=>'form-control alphanumericsp nospace debtor','type'=>'text','placeholder'=>"Enter Court File No", 'maxlength'=>'30', 'id'=>$c.'_court_file_no', 'value'=> $caseData['PrisonerCaseFile']['court_file_no'], 'title'=>'Court File No is required.','required'=>false));?>
                                    </div>
                                </div>
                            </div>
                            <div class="span6">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php echo $this->Form->text('PrisonerCaseFile.'.$c.'.case_file_no',array('div'=>false,'label'=>false,'class'=>'form-control alphanumericsp nospace debtor','type'=>'text', 'placeholder'=>'CASE FILE No.','required'=>false,'maxlength'=>'30','title'=>'Please enter case file no.','id'=>$c.'_case_file_no', 'value'=> $caseData['PrisonerCaseFile']['case_file_no'], 'title'=>'Case File No is required.'));?>
                                    </div>
                                </div>
                            </div> 
                            ...
                            if(isset($this->data['Prisoner']['prisoner_type_id']) && $this->data['Prisoner']['prisoner_type_id'] != Configure::read('DEBTOR'))
                            {
                                ...
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <?php echo $this->Form->text('PrisonerCaseFile.'.$c.'.date_of_warrant',array('div'=>false,'label'=>false,'class'=>'form-control maxCurrentDate','type'=>'text', 'placeholder'=>'Date Of Warrant','required'=>false,'id'=>$c.'_date_of_warrant','readonly','value'=>$date_of_warrant, 'title'=>'Select date of warrant'));?>
                                        </div>
                                    </div>
                                </div> 
                            <?php }?>
                            ...
                            <div class="span6">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php echo $this->Form->input('PrisonerCaseFile.'.$c.'.courtlevel_id',array('div'=>false,'label'=>false,'onChange'=>'getCourtList(this.value,'.$c.')','class'=>'form-control span11 pmis_select courtlevel_id debtor','type'=>'select','options'=>$courtLevelList, 'empty'=>'','required'=>false,'id'=>$c.'_courtlevel_id', 'selected'=> $caseData['PrisonerCaseFile']['courtlevel_id'], 'title'=>'Select Court Category'));?>
                                    </div>
                                </div>
                            </div>
                            <div class="span6">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        echo $this->Form->input('PrisonerCaseFile.'.$c.'.court_id',array('div'=>false,'label'=>false,'class'=>'form-control span11 pmis_select court_id debtor','type'=>'select','options'=>$courtList, 'onChange'=>'getCourtDetails(this.value)','empty'=>'','required'=>false,'id'=>$c.'_court_id', 'selected'=> $caseData['PrisonerCaseFile']['court_id'], 'title'=>'Select court name'));?>
                                    </div>
                                </div>
                            </div>
                            <?php 
                                        ...
                                        <div class="controls" id="<?php echo $c;?>_judges">
                                            ...
                                            if(count($judicial_officers) > 0)
                                            {
                                                ...
                                                foreach($judicial_officers as $judicial_officer)
                                                {
                                                    ...
                                                    $j++;
                                                    echo $this->Form->text('PrisonerCaseFile.'.$c.'.judicial_officer.',array('div'=>false,'label'=>false,'class'=>'form-control alphanumericsp judicial_officer','type'=>'text', 'placeholder'=>$judicialOfficerLevel,'id'=>$c.'_judicial_officer','required'=>false, 'value'=> $judicial_officer,'title'=>$judicialOfficerLevel.' is required.','style'=>$judicial_officer_style));
                                                }
                                            }
                                            ?>
                                        </div>
                                    ...
                                    <div class="row-fluid secondDiv" id="<?php echo $c;?>_offence_list">
                                        ...
                                        if(count($offencedata) > 0)
                                        {
                                            ...
                                            {   
                                                ...
                                                ?>
                                                <div class="span12 offence_list" style="background:#fff;border-top:1px solid #ddd;border-bottom:1px solid #ddd;box-shadow:0 0 5px #ddd;border-left:5px solid #a03230;margin:10px 0px; position:relative; padding-bottom: 10px;" id="<?php echo $c;?>_<?php echo $i;?>_offence_list">
                                                    ...
                                                    <div class="span6">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <?php 
                                                                echo $this->Form->input('PrisonerCaseFile.'.$c.'.PrisonerOffence.'.$i.'.offence',array('div'=>false,'label'=>false,'onChange'=>'getSOLaws(this.value,'.$c.','.$i.')','class'=>'form-control span11 pmis_select offence','type'=>'select','options'=>$offenceList, 'empty'=>'','required'=>false,'id'=>$i.'_offence_id', 'selected'=>$offenceDetailData['offence'], 'title'=>'Please select Offence.'));?>
                                                            </div>
                                                        </div>
                                                    </div>  
                                                    <div class="span6">
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                ...
                                                                {
                                                                    echo $this->Form->input('PrisonerCaseFile.'.$c.'.PrisonerOffence.'.$i.'.section_of_law',array('div'=>false,'label'=>false,'multiple'=>true,'class'=>'form-control span11 pmis_select','type'=>'select','options'=>$sectionOfLawList,'required'=>false,'id'=>$c.'_'.$i.'_section_of_law_id', 'selected'=>$selected_sol, 'title'=>'Please select section of law.'));
                                                                }
                                                                else 
                                                                {
                                                                    echo $this->Form->input('PrisonerCaseFile.'.$c.'.PrisonerOffence.'.$i.'.section_of_law',array('div'=>false,'label'=>false,'multiple'=>true,'class'=>'form-control span11 pmis_select','type'=>'select','options'=>$sectionOfLawList, 'required'=>false, 'id'=>$c.'_'.$i.'_section_of_law_id', 'selected'=>$selected_sol, 'title'=>'Please select section of law.'));
                    ...
                    <div class="span12 case_list" style="background:#fff;border-top:1px solid #ddd;border-bottom:1px solid #ddd;box-shadow:0 0 5px #ddd;border-left:5px solid #a03230;margin:10px 0px; position:relative; padding-bottom: 10px;">
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo $this->Form->input('Convict.PrisonerCaseFile.0.court_file_no',array('div'=>false,'label'=>false,'class'=>'form-control alphanumericsp nospace debtor','type'=>'text','placeholder'=>"Enter Court File No",'required'=>false,'id'=>'0_court_file_no', 'maxlength'=>'30', 'title'=>'Court File No is required.'));?>
                                </div>
                            </div>
                        </div>
                        <div class="span6">
                            <div class="control-group">
                                <label class="control-label">Case File No. <?php echo $req; ?>:</label>
                                <div class="controls">
                                    <?php echo $this->Form->text('Convict.PrisonerCaseFile.0.case_file_no',array('div'=>false,'label'=>false,'class'=>'form-control alphanumericsp nospace case_file_no debtor','type'=>'text', 'placeholder'=>'CASE FILE No.','required'=>false,'title'=>'Please enter case file no.', 'maxlength'=>'30'));?>
                                </div>
                            </div>
                        </div> 
                        <div class="clearfix"></div>  
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo $this->Form->input('Convict.PrisonerCaseFile.0.crb_no',array('div'=>false,'label'=>false,'class'=>'form-control alphanumericsp nospace','type'=>'text', 'placeholder'=>'Enter C.R.B No.','required'=>false,'id'=>'0_crb_no', 'maxlength'=>'30', 'title'=>'C.R.B No is required.'));?> 
                                </div>
                            </div>
                        </div> 
                        <?php 
                        if(isset($this->data['Prisoner']['prisoner_type_id']) && $this->data['Prisoner']['prisoner_type_id'] != Configure::read('DEBTOR'))
                        {
                            ...
                            <div class="span6">
                                <div class="control-group">
                                    <label class="control-label">Date Of Warrant <?php echo $req; ?>:</label>
                                    <div class="controls">
                                        <?php echo $this->Form->text('Convict.PrisonerCaseFile.0.date_of_warrant',array('div'=>false,'label'=>false,'class'=>'form-control maxCurrentDate date_of_warrant','type'=>'text', 'placeholder'=>'Date Of Warrant','required'=>false,'id'=>'date_of_warrant','readonly','value'=>$date_of_warrant));?>
                                    </div>
                                </div>
                            </div> 
                        <?php }?>
                        ...
                        <div class="span6">
                            <div class="control-group">
                                <label class="control-label">Court Category<?php echo $req; ?>:</label>
                                <div class="controls">
                                    <?php echo $this->Form->input('Convict.PrisonerCaseFile.0.courtlevel_id',array('div'=>false,'label'=>false,'onChange'=>'getCourtList(this.value,0)','class'=>'form-control span11 courtlevel_id pmis_select debtor','type'=>'select','options'=>$courtLevelList, 'empty'=>'','required'=>false, 'id'=>'0_courtlevel_id', 'title'=>'Select Court Category'));?>
                                </div>
                            </div>
                        </div>
                        <div class="span6">
                            <div class="control-group">
                                <label class="control-label">Court Name<?php echo $req; ?>:</label>
                                <div class="controls">
                                    <?php echo $this->Form->input('Convict.PrisonerCaseFile.0.court_id',array('div'=>false,'label'=>false,'class'=>'form-control span11 pmis_select court_id debtor','type'=>'select','options'=>$courtList, 'onChange'=>'getCourtDetails(this.value)','empty'=>'','required'=>false,'id'=>'0_court_id', 'title'=>'Select Court name'));?>
                                </div>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="span6">
                            <div class="control-group">
                                ...
                                {?>
                                    ...
                                    <div class="controls">
                                        <?php
                                            echo $this->Form->input('Convict.PrisonerCaseFile.0.magisterial_id',array(
                                              'div'=>false,
                                              'label'=>false,
                                              'class'=>'pmis_select',
                                              'type'=>'select',
                        ...
                        <div class="span6">
                            <div class="control-group">
                                ...
                                {?>
                                    ...
                                    <div class="">
                                        <?php echo $this->Form->text('Convict.PrisonerCaseFile.0.judicial_officer.',array('div'=>false,'label'=>false,'class'=>'form-control alphanumericsp','type'=>'text', 'placeholder'=>$judicialOfficerLevel,'id'=>'0_judicial_officer','required'=>false));?>
                                    </div>
                            <?php }
                                else {?>
                                    <!-- <label class="control-label" id="0_magistrate_level"><?php //echo $judicialOfficerLevel;?>:</label> -->
                                    <div class="">
                                        <?php echo $this->Form->text('Convict.PrisonerCaseFile.0.judicial_officer.',array('div'=>false,'label'=>false,'class'=>'form-control alphanumericsp','type'=>'text', 'placeholder'=>$judicialOfficerLevel,'required'=>false,'id'=>'0_judicial_officer'));?>
                                    </div>
                            <?php }?>
                            </div>
                        </div>
                            <button class="btn btn-success btn-add judges_btn hidden" type="button" style="padding: 8px 8px; float:right;" id="0_judges_btn" onclick="addJudge(0);">
                            <span class="icon icon-plus"></span>
                            </button>
                            <button class="btn btn-danger btn-add judges_btn hidden" type="button" style="padding: 8px 8px; float:right;" id="0_judges_remove_btn" onclick="removeJudge(0);">
                                <span class="icon icon-minus"></span>
                            </button>
                        </div>
                        <div class="clearfix"></div>
                        <div class="span6 hidden" id="0_highcourt_file_no_reqd">
                            <div class="control-group">
                                <label class="control-label">High Court File No<?php echo $req;?>:</label>
                                <div class="controls">
                                    <?php echo $this->Form->input('Convict.PrisonerCaseFile.0.highcourt_file_no',array('div'=>false,'label'=>false,'class'=>'form-control alphanumericsp nospace','type'=>'text', 'placeholder'=>'Enter High Court File No.','required'=>false,'id'=>'0_highcourt_file_no', 'maxlength'=>'30', 'title'=>' High Court File No is required.'));?> 
                                </div>
                            </div>
                        </div>
                        <!-- Offence detail START -->
                                    ...
                                    <div class="span12 offence_list" style="background:#fff;border-top:1px solid #ddd;border-bottom:1px solid #ddd;box-shadow:0 0 5px #ddd;border-left:5px solid #a03230;margin:10px 0px; position:relative; padding-bottom: 10px;">
                                        ...
                                        <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <?php 
                                                    echo $this->Form->input('Convict.PrisonerCaseFile.0.PrisonerOffence.0.offence',array('div'=>false,'label'=>false,'onChange'=>'getSOLaws(this.value,0,0)','class'=>'form-control span11 pmis_select offence debtor','type'=>'select','options'=>$offenceList, 'empty'=>'','required'=>false,'id'=>'0_0_offence_id','title'=>'Please select Offence.'));?>
                                                </div>
                                            </div>
                                        </div>  
                                        <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <?php 
                                                    echo $this->Form->input('Convict.PrisonerCaseFile.0.PrisonerOffence.0.section_of_law',array('div'=>false,'label'=>false,'multiple'=>true,'class'=>'form-control span11 pmis_select','type'=>'select','options'=>$sectionOfLawList, 'required'=>false,'id'=>'0_0_section_of_law_id', 'title'=>'Please select section of law.'));?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <?php 
                                                    $idname = "'admission'";
                                                    echo $this->Form->input('Convict.PrisonerCaseFile.0.PrisonerOffence.0.offence_category_id',array('div'=>false,'label'=>false,'class'=>'form-control span11 pmis_select debtor','type'=>'select','options'=>$offenceCategoryList, 'empty'=>'','required'=>false,'id'=>'admission_offence_category_id','title'=>'Please select Offence Category.'));?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="span6">
                                            <div class="control-group">
                                                <label class="control-label">Place of offence:</label>
                                                <div class="controls">
                                                    <?php echo $this->Form->input('Convict.PrisonerCaseFile.0.PrisonerOffence.0.place_of_offence',array('div'=>false,'label'=>false,'class'=>'form-control span11','type'=>'text','placeholder'=>"Enter Place of Offence",'required'=>false,'id'=>'place_of_offence', 'maxlength'=>'30'));?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="span6">
                                           <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <?php echo $this->Form->input('Convict.PrisonerCaseFile.0.PrisonerOffence.0.district_id',array('div'=>false,'label'=>false,'class'=>'form-control span11 pmis_select','type'=>'select','options'=>$allDistrictList, 'empty'=>'','required'=>false,'id'=>'district_id3'));?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
