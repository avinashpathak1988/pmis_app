...
<div class="span12" style="background:#fff;border-top:1px solid #ddd;border-bottom:1px solid #ddd;box-shadow:0 0 5px #ddd;border-left:5px solid #a03230;margin:10px 0px;">
    ...
    margin-left: 112px;" >
        ...
        <div class="scountDiv2" id="visitorPrisonerCashItemsDiv"> 
            ...
            if(isset($this->request->data['VisitorPrisonerCashItem']) && count($this->request->data['VisitorPrisonerCashItem']) > 0)
            {
                $VisitorPrisonerCashItem  =   $this->request->data['VisitorPrisonerCashItem'];
            }
            if(isset($VisitorPrisonerCashItem)  && count($VisitorPrisonerCashItem) > 0)
            {
                $i = 0;
                $total_scount = count($VisitorPrisonerCashItem);
                ...
                <?php
                foreach($VisitorPrisonerCashItem as $VisitorItem)
                {

                    ?>

                    <div class="entry2 visitorItemEntry input-group row-fluid uradioBtn">
                    <?php echo $this->Form->input('VisitorPrisonerCashItem.'.$i.'.id', array('type'=>'hidden'))?>
                        

                        <?php echo $this->Form->input('VisitorPrisonerCashItem.'.$i.'.is_collected',array('div'=>false,'label'=>false,'type'=>'hidden' ,'required'=>false,'value'=> $VisitorItem["is_collected"]==1?'true':'false'));?>
                    <div class="span3">
                            
                                    <?php echo $this->Form->input('VisitorPrisonerCashItem.'.$i.'.cash_details',array('div'=>false,'label'=>false,'placeholder'=>'Enter Cash Details','class'=>'form-control  alphanumericone','id'=>'cash_details','required'));?>
                    </div> 
                    <div class="span3">
                         <?php echo $this->Form->input('VisitorPrisonerCashItem.'.$i.'.pp_amount',array('div'=>false,'label'=>false,'placeholder'=>'Enter pp cash amount','class'=>'form-control  numeric','id'=>'pp_amount','required'=>'Please enter PP cash amount','required'));?>
                    </div>
                    <div class="span3">
                        <?php echo $this->Form->input('VisitorPrisonerCashItem.'.$i.'.pp_cash',array('div'=>false,'label'=>false,'class'=>'form-control ','type'=>'select','id'=>'pp_cash','empty'=>'--Select--','options'=>$ppcash,'required','style'=>'width:180px;','title'=>'Please select type of pp cash'));?>
                    </div>
            ...
            {?>
                ...
                <div class="entry2 visitorItemEntry input-group row-fluid uradioBtn">
                    ...
                    <div class="span3">
                                    ...
                                    <?php echo $this->Form->input('VisitorPrisonerCashItem.0.cash_details',array('div'=>false,'label'=>false,'placeholder'=>'Enter Cash Details','class'=>'form-control  alphanumericone','id'=>'cash_details','required'=>false));?>
                    </div>
                    <div class="span3">

                        
                                        <?php echo $this->Form->input('VisitorPrisonerCashItem.0.pp_amount',array('div'=>false,'label'=>false,'placeholder'=>'Enter pp cash amount','class'=>'form-control  numeric','id'=>'pp_amount','style'=>'width:180px;','required'=>false));?>
                                 
                    </div>
                    <div class="span3">

                                           <?php echo $this->Form->input('VisitorPrisonerCashItem.0.pp_cash',array('div'=>false,'label'=>false,'class'=>'form-control ','type'=>'select','id'=>'pp_cash','empty'=>'--Select--','options'=>$ppcash,'required'=>false,'title'=>'Please select type of pp cash'));?>
                    </div>
...
$(function()
{
    ...
    {
        e.preventDefault();
        $("#visitorPrisonerCashItemsDiv select").select2("destroy");
        $("#visitorPrisonerCashItemsDiv select").select2('val','');
        ...
        scount2 = scount2-1; 
        //alert(scount2);
        var item_id_name = "data[VisitorPrisonerCashItem]["+scount2+"][cash_details]";
        var item_id_id = "VisitorPrisonerCashItem"+scount2+"cash_details";
        ...
        var quantity_name = "data[VisitorPrisonerCashItem]["+scount2+"][pp_amount]";
        var quantity_name_id = "VisitorPrisonerCashItem"+scount2+"pp_amount";
        ...
        var currency_name = "data[VisitorPrisonerCashItem]["+scount2+"][pp_cash]";
        var currency_name_id = "VisitorPrisonerCashItem"+scount2+"pp_cash";
        ...
        $("#VisitorPrisonerCashItem"+scount2+"pp_amount").val('');
        //$('#prisoner_no').select2();
        $('#pp_cash').select2();

        for(var i = 1;i <= scount2 ; i++){
            var currency_name_id = "VisitorPrisonerCashItem"+i+"pp_cash";
            $('#'+currency_name_id).select2();
        }
