    ...
    <div class="span12" style="background:#fff;border-top:1px solid #ddd;border-bottom:1px solid #ddd;box-shadow:0 0 5px #ddd;border-left:5px solid #a03230;margin:10px 0px; position:relative; padding-bottom: 10px;">
        <div class="span6">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $this->Form->input('personal_no',array('div'=>false,'label'=>false,'class'=>'form-control span11','type'=>'text','readonly','value'=>$this->request->data['Prisoner']['fullname']));?>
                    </div>
                </div>
            </div>
            <div class="span6">
        ...
        <div class="span6">
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    echo $this->Form->input('court_id',array('div'=>false,'label'=>false,'class'=>'form-control span11 pmis_select court_id','type'=>'select','options'=>$courtList, 'empty'=>'','required','id'=>'petition_court_id','title'=>'Select court name'));?>
                </div>
            </div>
        </div>
        <div class="clearfix"></div>
...
function getPetitionOffence(id){
  var strURL = '<?php echo $this->Html->url(array('controller'=>'Prisoners','action'=>'getPetitionOffence'));?>/'+id;
