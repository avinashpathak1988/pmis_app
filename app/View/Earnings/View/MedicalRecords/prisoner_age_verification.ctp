        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    <h5>Prisoner Age Verifications</h5> 
...
<?php
$ajaxUrl = $this->Html->url(array('controller'=>'MedicalRecords','action'=>'prisonerAgeVerificationAjax'));
$checkDischargeDetailsAjaxUrl = $this->Html->url(array('controller'=>'MedicalRecords','action'=>'prisonerAgeVerificationAjax'));
