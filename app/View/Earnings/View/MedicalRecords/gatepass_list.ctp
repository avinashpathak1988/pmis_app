...
<?php
$ajaxUrl            = $this->Html->url(array('controller'=>'MedicalRecords','action'=>'gatepassListAjax'));
$commonHeaderUrl    = $this->Html->url(array('controller'=>'Prisoners','action'=>'getCommonHeder'));
$checkDischargeDetailsAjaxUrl = $this->Html->url(array('controller'=>'MedicalRecords','action'=>'checkDischargeDetails'));
