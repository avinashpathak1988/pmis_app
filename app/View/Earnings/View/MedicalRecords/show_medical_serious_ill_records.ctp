    ...
    <thead>
        ...
        <th>
          ...
          ?>
            ...
            ?></th>
            <th><?php                 
                echo $this->Paginator->sort('MedicalSeriousIllRecord.medical_officer_id_other','Medical Personnel',array('update'=>'#seriousIllListingDiv','evalScripts' => true,'url'=>array('controller' => 'MedicalRecords','action' => 'showMedicalSeriousIllRecords','status'=> $status,'prisoner_id'=> $prisoner_id,'uuid'=> $uuid)));
            ?></th>
            <th><?php                 
                echo $this->Paginator->sort('MedicalSeriousIllRecord.hospital_id','Hospital Name',array('update'=>'#seriousIllListingDiv','evalScripts' => true,'url'=>array('controller' => 'MedicalRecords','action' => 'showMedicalSeriousIllRecords','status'=> $status,'prisoner_id'=> $prisoner_id,'uuid'=> $uuid)));
            ?></th>
            <th><?php                 
                echo $this->Paginator->sort('MedicalSeriousIllRecord.category_id','Recomendation Category',array('update'=>'#seriousIllListingDiv','evalScripts' => true,'url'=>array('controller' => 'MedicalRecords','action' => 'showMedicalSeriousIllRecords','status'=> $status,'prisoner_id'=> $prisoner_id,'uuid'=> $uuid)));
            ?></th>
            <th><?php                 
...
?>
        ...
        if(!isset($is_excel)){
          ...
          ?>
            ...
            <td><?php echo (isset($data["MedicalSeriousIllRecord"]["check_up_date"]) && $data["MedicalSeriousIllRecord"]["check_up_date"]!='0000-00-00') ? date('d-m-Y', strtotime($data["MedicalSeriousIllRecord"]["check_up_date"])) : ''; ?></td>
            <td><?php echo $data["MedicalSeriousIllRecord"]["priority"]?></td>
            <td><?php echo $data["User"]["name"]?></td>
            <td><?php if ($data["MedicalSeriousIllRecord"]["hospital_id"]!='') {
              echo $funcall->getName($data["MedicalSeriousIllRecord"]["hospital_id"],'Hospital','name');
             }else{
              echo ('NA');
             }?></td>
...
?>              
            <td>
              ...
              <?php echo $this->Form->create('MedicalSeriousIllRecordDelete',array('url'=>'/medicalRecords/add#seriouslyill/','admin'=>false, 'id'=>'MedicalSeriousIllRecordDelete'));?> 
              <?php echo $this->Form->input('id',array('type'=>'hidden','value'=> $data['MedicalSeriousIllRecord']['id'])); ?>
...
function editForm(){
      AsyncConfirmYesNo(
                ...
                'No',
                function(){
                    $('#MedicalSeriousIllRecordEdit').submit();
                },
                function(){
  ...
  function deleteForm(){
      AsyncConfirmYesNo(
                ...
                'No',
                function(){
                    $('#MedicalSeriousIllRecordDelete').submit();
                },
                function(){
