...
<?php
    $this->Paginator->options(array(
        ...
        'url'                       => array(
            ...
            'action'                => 'monthlyPrisonerAdmittedAjax',
...
?>
    ...
    <tr>
      ...
      <td><?php echo $funcall->getName($value['Prisoner']['prisoner_type_id'],"PrisonerType","name");?></td>
      <td><?php echo $funcall->PriosnerOffenceame($value['Prisoner']['id']);?></td>
    </tr>
<?php
$rowCnt++;
}
