...
<?php
    $this->Paginator->options(array(
        ...
        'url'                       => array(
            ...
            'action'                => 'childernHandedOverMonthlyAjax',
...
<table id="districtTable" class="table table-bordered data-table table-responsive">
  <thead>
    <tr>
      ...
      <th>Age on Handover</th>
      <th>Date of Handover</th>
      <th>Name of reciving person/ Organisation </th>
      <th>Releation ship</th>
      <th>Telephone Contact of Receiving pereson</th>
...
?>
    ...
    <tr>
      ...
      <td></td>
      <td><?php echo h(date('d-m-Y', strtotime($value['PrisonerChildDetail']['date_of_handover'])))?></td>
      <td><?php echo h($value['PrisonerChildDetail']['name_of_rcv_person'])?></td>
      <td><?php echo $value['PrisonerChildDetail'][''];?></td>
      <td><?php echo $value['PrisonerChildDetail']['relation_with_child'];?></td>
     <td><?php echo $value['PrisonerChildDetail']['contact_no_of_rcv_person'];?></td>
      <td><?php echo h($value['PrisonerChildDetail']['rcv_person_add'])?></td>
