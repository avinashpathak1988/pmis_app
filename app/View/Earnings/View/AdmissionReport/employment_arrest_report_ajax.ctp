...
<?php
    $this->Paginator->options(array(
        ...
        //'complete'                    => '$("#lodding_image").hide();',
            ...
            'action'                    => 'employmentArrestReportAjax',
...
<?php
   ...
   $exUrl = "employmentArrestReportAjax";
    ...
    if($showOnly != 0){
         ...
         foreach($datas as $data){
                    //$convictedMales
                        ...
                        $convictedCounts = $funcall->employmentconvitCount($data['Prison']['id'],$showOnly,$fromDate,$toDate); 
                        $remandCounts = $funcall->employmentremandCount($data['Prison']['id'],$showOnly,$fromDate,$toDate);
                        $debtorCounts = $funcall->employmentdebtorCount($data['Prison']['id'],$showOnly,$fromDate,$toDate); ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $employemnt[$showOnly] ?></td>
        ...
        <?php        
          ...
          foreach($datas as $data){
                ...
                foreach ($employemnt as $key => $value) {


                        $convictedCounts = $funcall->employmentconvitCount($data['Prison']['id'],$key,$fromDate,$toDate); 
                        $remandCounts = $funcall->employmentremandCount($data['Prison']['id'],$key,$fromDate,$toDate);
                        $debtorCounts = $funcall->employmentdebtorCount($data['Prison']['id'],$key,$fromDate,$toDate); ?>
