            ...
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                    ...
                    <div style="float:right;padding-top: 7px;">
                        <?php echo $this->Html->link(__('Add New Compound'), array('action' => 'add'), array('escape'=>false,'class'=>'btn btn-mini btn-primary')); ?>
                        &nbsp;&nbsp;
                    </div>
                </div>
                    ...
                    <div class="row" style="padding-bottom: 14px;">
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo $this->Form->input('name', array('type'=>'text','class'=>'form-control','id'=>'name','div'=>false,'label'=>false,'placeholder'=>'Enter Compound Name'))?>
                                </div>
                            </div>
                        </div>  
...
<?php
$ajaxUrl      = $this->Html->url(array('controller'=>'Compounds','action'=>'indexAjax'));
