          ...
          <link href="//netdna.bootstrapcdn.com/bootstrap/3.0.0/css/bootstrap-glyphicons.css" rel="stylesheet">
                ...
                //'../theme/css/datepicker',
                   // ,'timepicki'
                    ...
                    echo $this->Html->script(array('../theme/js/lightbox-plus-jquery.min','../theme/js/jquery.min', 'jquery-ui','../theme/js/jquery.ui.custom','../theme/js/bootstrap.min','../theme/js/jquery.uniform','../theme/js/select2.min','../theme/js/jquery.dataTables.min','../theme/js/matrix','../theme/js/matrix.tables','../alertify/src/alertify','../theme/js/jquery.validate','../theme/js/additional-methods.min','tabbedcontent.min', 'analytics.min','../theme/js/bootstrap-datetimepicker.min','timepicki','../theme/js/bootstrap-datepicker','../theme/js/rating','../highchart/code/highcharts'));
...
<div style="z-index: 106;width: 100%;background: gray;position: fixed;height: 100%; opacity: 0.6" id="pmis_loader">
  <!-- <img src="<?php echo $this->webroot;?>theme/img/uganda_flag2.gif" style="position:fixed;left:50%;top:50%;"> -->
  <div style="position:fixed;left:50%;top:50%; color:#A03230; font-size: 30px;">Loading...</div>
</div>
<!--Header-part-->
<div id="header">
...
<div id="content">
	<div style="z-index: 106;width: 100%;background: gray;position: fixed;height: 100%; opacity: 0.6; display: none;" id="pmis_loader2">
	  <div style="position:fixed;left:50%;top:50%; color:#A03230; font-size: 30px;">Loading...</div>
	</div>
