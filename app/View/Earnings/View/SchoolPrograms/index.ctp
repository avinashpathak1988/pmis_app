        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                    <h5>School Program List</h5>
                    <div style="float:right;padding-top: 7px;">
                        <?php echo $this->Html->link('Add New School Program',array('action'=>'add'),array('class' => 'btn btn-mini btn-primary'));?>
                        &nbsp;&nbsp;
                    </div>
                </div>
                        ...
                        <table id="example2" class="table table-bordered table-hover table-responsive">
                            <thead>
                                <tr>
                                    ...
                                    <th>Sub-Program Category1</th>
                                    <th>Sub-Program Category2</th>
                                    <th>Is Enable ?</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
...
<?php
$ajaxUrl = $this->Html->url(array('controller'=>'SchoolPrograms','action'=>'indexAjax'));
