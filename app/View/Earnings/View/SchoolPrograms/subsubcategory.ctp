            ...
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                    ...
                    <div style="float:right;padding-top: 7px;">
                        <?php echo $this->Html->link('Add New Sub Sub category Program',array('action'=>'addsubsubcategory'),array('class' => 'btn btn-mini btn-primary'));?>
                        &nbsp;&nbsp;
                    </div>
                </div>
...
?>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php echo $this->Form->create('SchoolProgramDelete',array('url'=>'/SchoolPrograms/deleteSubSubProgram','admin'=>false));?> 
                                        <?php echo $this->Form->input('id',array('type'=>'hidden','value'=> $data['SubCategorySchoolProgram']['id'])); ?>
...
<?php
$ajaxUrl = $this->Html->url(array('controller'=>'SchoolPrograms','action'=>'subsubcategoryAjax'));
