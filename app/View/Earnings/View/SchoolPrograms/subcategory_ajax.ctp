...
<table class="table table-bordered data-table table-responsive">
    <thead>
        <tr>
         ...
         <!--  <th>
            <?php                 
          echo $this->Paginator->sort('SchoolProgram.parent_id','Parent',array('update'=>'#listingDiv','evalScripts' => true,'url'=>array('controller' => 'SchoolPrograms','action' => 'indexAjax')));
          ?></th>
          <th>
            <?php                 
          echo $this->Paginator->sort('SchoolProgram.sub_parent_id','Sub-Parent',array('update'=>'#listingDiv','evalScripts' => true,'url'=>array('controller' => 'SchoolPrograms','action' => 'indexAjax')));
          ?></th> -->
            <th>
            <?php                 
...
?>
        <tr>
            ...
            <td><?php if($data['SubSchoolProgram']['name']!='')echo ucwords(h($data['SubSchoolProgram']['name']));else echo Configure::read('NA'); ?>&nbsp;</td>    
