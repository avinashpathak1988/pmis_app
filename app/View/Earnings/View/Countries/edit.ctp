<?php
echo $this->Html->link('Manage Countries',array(
  'action'=>'index'
));
 ?>
      ...
      <?php echo $this->Form->create('Country'); ?>
          <div class="box-body">
            <div class="form-group">
              <div class="row">
                <label class="col-sm-4 col-md-3 lableTopMar">Country<font style='color:red'>*</font></label>
                <div class="col-sm-5 col-md-6">
                  <?php
                    ...
                    echo $this->Form->input('nationality_name',array(
                      'div'=>false,
                      'label'=>false,
