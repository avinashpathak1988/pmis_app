<?php
echo $this->Html->link('Manage Weight Unit',array(
  'action'=>'index'
));
 ?>
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="col-md-7">
      <?php echo $this->Form->create('WeightUnit'); ?>
          <div class="box-body">
            <div class="form-group">
              <div class="row">
                <label class="col-sm-4 col-md-3 lableTopMar">Weight Unit <font style='color:red'>*</font></label>
