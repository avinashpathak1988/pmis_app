<?php
echo $this->Html->link('Manage Skill Set',array(
  'action'=>'index'
));
 ?>
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="col-md-7">
      <?php echo $this->Form->create('SkillSet'); ?>
          <div class="box-body">
            <div class="form-group">
              <div class="row">
                <label class="col-sm-4 col-md-3 lableTopMar">Skill Set  <font style='color:red'>*</font></label>
