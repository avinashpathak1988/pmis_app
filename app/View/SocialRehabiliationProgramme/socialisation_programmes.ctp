                ...
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    ...
                    <h5>Socialisation Programmes</h5>
                     <div style="float:right;padding-top: 7px;">
                        <?php echo $this->Html->link(__('Add New'), array('action' => 'addSocialisationProgrammes'), array('escape'=>false,'class'=>'btn btn-success btn-mini')); ?>
                        &nbsp;&nbsp;
                    </div>
                </div>
                <div class="widget-content nopadding">
                    ...
                    <?php echo $this->Form->create('Search',array('class'=>'form-horizontal'));?>
                        <div id="searchPrisonerTwo" class="row collapse" style="height:auto;">
                          ...
                          <div class="span12 add-top" align="center" valign="center">
                                ...
                                <?php echo $this->Form->input('Reset', array('type'=>'reset', 'div'=>false,'label'=>false, 'class'=>'btn btn-danger', 'onclick'=>"resetData('SearchSocialisationProgrammesForm')"))?>
                            </div> 
                    </div> 
                                <?php echo $this->Form->end();?>
                    </div>
                    <div id="SocialisationProgramList"></div>
                    <div id="addHeadRemarkModal" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <?php echo $this->Form->input('id',array('div'=>false,'label'=>false,'class'=>'form-control ','id'=>'socialisation_program_id','type'=>'hidden'));?>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="control-group">
                                    <label class="control-label">Prisoner Qualities :<?php echo $req; ?></label>
                                    <div class="controls">
                                        <?php echo $this->Form->input('prisoner_qualities',array('div'=>false,'label'=>false,'class'=>'form-control ','type'=>'text','placeholder'=>'Enter Prisoner Qualities','id'=>'prisoner_qualities','rows'=>3,'required'=>false,'maxlength'=>1000));?>
                                    </div>
                                    </div>
                                </div>
...
$ajaxUrlSocialisationProgramList = $this->Html->url(array('controller'=>'SocialRehabiliationProgramme','action'=>'socialisationProgramAjax'));
$ajaxUrlDiscontinue = $this->Html->url(array('controller'=>'SocialRehabiliationProgramme','action'=>'discontinueSocialisation'));
$ajaxUrlcontinue = $this->Html->url(array('controller'=>'SocialRehabiliationProgramme','action'=>'continueSocialisation'));
...
?>
    ...
    $( document ).ready(function() {
        ...
        var url ='<?php echo $ajaxUrlSocialisationProgramList?>';
            $.post(url,{},function(res) {
                if (res) {
                    $('#SocialisationProgramList').html(res);
                    
                 }else{
                    
                    $('#SocialisationProgramList').html('No records found !');
    ...
    function showListSearch(){
        ...
        var url ='<?php echo $ajaxUrlSocialisationProgramList?>';
        $.post(url, $('#SearchSocialisationProgrammesForm').serialize(), function(res) {
            if (res) {
                        $('#SocialisationProgramList').html(res);
                 }else{
                        $('#SocialisationProgramList').html('No records found !');
 ...
 function discontinueSocial(id){
  ...
  function continueSocial(id){
    ...
    function finalSave(id){
        ...
        $.post(url,{'id':id,'model':'SocialisationProgram'}, function(res) {
                if (res == 'success') {
                    //dynamicAlertBox('Message', 'continued successfully !');
                    location.reload();
                }else{
  ...
  function submitHeadRemark(){
    var url ='<?php echo $ajaxUrlsubmitHeadRemark?>';
        $.post(url,$('#SocialisationProgramSocialisationProgrammesForm').serialize(), function(res) {
                if (res == 'success') {
                    //dynamicAlertBox('Message', 'continued successfully !');
                    location.reload();
                }else{
