...
<?php
$internal_offence_id = (isset($this->data['InPrisonOffenceCapture']['internal_offence_id']) && $this->data['InPrisonOffenceCapture']['internal_offence_id']!='') ? $this->data['InPrisonOffenceCapture']['internal_offence_id'] : '';
?>
...
$(document).ready(function(){
    ...
    if(isset($this->data['InPrisonOffenceCapture']) && is_array($this->data['InPrisonOffenceCapture']) && count($this->data['InPrisonOffenceCapture'])>0){
        ...
        showOffences('<?php echo $this->data['InPrisonOffenceCapture']['offence_type']; ?>');
        $('#internal_offence_id').select2('val', '<?php echo $this->data['InPrisonOffenceCapture']['internal_offence_id']; ?>');
        <?php
    }
