        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    <h5>Cellular Confinement List</h5>
                            ...
                            <div class="row" style="padding-bottom: 14px;">
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <?php echo $this->Form->input('prisoner_id',array('div'=>false,'label'=>false,'type'=>'select','empty'=>'','options'=>$prisonerListData, 'class'=>'form-control pmis_select','required', 'id'=>'prisoner_id'));?>
                                        </div>
                                    </div>
                                </div>
                                <!-- <div class="span6">
...
<?php
$ajaxUrl            = $this->Html->url(array('controller'=>'InPrisonOffenceCapture','action'=>'punishmentConfineListAjax'));
$ajaxConfineUrl            = $this->Html->url(array('controller'=>'InPrisonOffenceCapture','action'=>'ConfineAjax'));
...
<script type="text/javascript">
 $(document).ready(function(){
    ...
    function confinementHistory(val,id){
        var test = val;
        var id = id;
        if($("#ward_id"+id).val()==''){
            ...
            AsyncConfirmYesNo(
                ...
                function(){
                    ...
                    url = url + '/val:'+test;
                    url = url + '/id:'+id;
                    url = url + '/prisoner_id:' + $("#prisoner_id"+id).val();
                    url = url + '/ward_id:' + $("#ward_id"+id).val();
                    url = url + '/ward_cell_id:' + $("#ward_cell_id"+id).val();
                    $.post(url, {}, function(res) { 
                        if(res == 'Success'){
                            $('#myModalOther'+id).modal('hide');
                            showData();
                        }
                    });
                },
