                        ...
                        <div class="span12">
                            <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <span class="" style="">
                                            <?php echo $this->Form->input('prison',array('div'=>false,'label'=>false,'class'=>'dotted-input','style'=>'width:80%;','type'=>'text','required'=>false,'id'=>'prison','value'=>isset($data['Prison']['name'])? $data['Prison']['name']: '' ));?>
                                    </span>
                                </div>
                                <div class="form-row">
                                     <span class="form-text" style="width:10%">Name (In full) : </span>
                                    <span class="" style="">
                                            <?php echo $this->Form->input('name',array('div'=>false,'label'=>false,'class'=>'dotted-input','style'=>'width:76%;','type'=>'text','required'=>false,'id'=>'name','value'=>isset($data['Prisoner']['first_name'])? $data['Prisoner']['first_name'] .' ' . $data['Prisoner']['last_name']: '' ));?>
                                    </span>
                                </div>
                                <div class="form-row">
