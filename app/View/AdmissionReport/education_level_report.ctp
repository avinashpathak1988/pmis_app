        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    <h5>Summary of education levels of prisoners in custody by sex</h5>
                         ...
                         <div class="row" style="padding-bottom: 14px;">
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <?php echo $this->Form->input('from_date', array('type'=>'text', 'id'=>'from_date', 'class'=>'span11 from_date','readonly'=>true,'div'=>false,'label'=>false,'placeholder'=>'Enter from date','required'))?>
                                        </div>
                                    </div>
                                </div>
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <?php echo $this->Form->input('to_date', array('type'=>'text', 'id'=>'to_date', 'class'=>'span11 to_date','div'=>false,'readonly'=>true,'label'=>false,'placeholder'=>'Enter to date','required'))?>
                                        </div>
                                    </div>
                                </div>
                                <div class="span6">
                           ...
                           <div class="control-group">
                                ...
                                <div class="controls">
                                   <?php
                                    echo $this->Form->input('level_of_education_id',array(
                                      'div'=>false,
                                      'label'=>false,
                                      'class'=>'span11 pmis_select',
                                      'empty'=>'',
                                      'options'=>$levelofeducation,
                                      'id'=>'level_of_education_id'
                                    ));
                                ?>
                                </div>
                            </div>
...
<?php
$ajaxUrl        = $this->Html->url(array('controller'=>'AdmissionReport','action'=>'educationLevelReportAjax'));
...
echo $this->Html->scriptBlock("
    ...
    function showData(){
        ...
        url = url + '/level_of_education_id:'+$('#level_of_education_id').val();
