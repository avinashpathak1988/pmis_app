        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    <h5>Summary of Employement of prisoners At arrest by sex</h5>
                        ...
                        <div class="row" style="padding-bottom: 14px;">
                         ...
                         <div class="row" style="padding-bottom: 14px;">
                           ...
                           <div class="control-group">
                                ...
                                <div class="controls">
                                   <?php
                                    echo $this->Form->input('employment_type',array(
                                      'div'=>false,
                                      'label'=>false,
...
<?php
$ajaxUrl        = $this->Html->url(array('controller'=>'AdmissionReport','action'=>'employmentArrestReportAjax'));
...
echo $this->Html->scriptBlock("
    ...
    function showData(){
        ...
        url = url + '/employment_type:'+$('#employment_type').val();
