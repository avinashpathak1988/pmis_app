...
<?php
$ajaxUrl            = $this->Html->url(array('controller'=>'Prisonerinouts','action'=>'gatepassListAjax'));
$commonHeaderUrl    = $this->Html->url(array('controller'=>'Prisoners','action'=>'getCommonHeder'));
$checkDischargeDetailsAjaxUrl = $this->Html->url(array('controller'=>'Prisonerinout','action'=>'checkDischargeDetails'));
