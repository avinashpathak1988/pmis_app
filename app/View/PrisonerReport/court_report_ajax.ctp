    ...
    if($showOnly != 0){
         foreach($datas as $data){
                    //$convictedMales
                        ...
                        $convictedCounts = $funcall->courtWiseCount($data['Prison']['id'],$showOnly,$fromDate,$toDate,'Convicted'); 
                        $remandCounts = $funcall->courtWiseCount($data['Prison']['id'],$showOnly,$fromDate,$toDate,'Remand');
                        $debtorCounts = $funcall->courtWiseCount($data['Prison']['id'],$showOnly,$fromDate,$toDate,'Debtor'); ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $courtList[$showOnly] ?></td>
        ...
        <?php        
          ...
          foreach($datas as $data){
                ...
                foreach ($courtList as $key => $value) {


                        $convictedCounts = $funcall->courtWiseCount($data['Prison']['id'],$key,$fromDate,$toDate,'Convicted'); 
                        $remandCounts = $funcall->courtWiseCount($data['Prison']['id'],$key,$fromDate,$toDate,'Remand');
                        $debtorCounts = $funcall->courtWiseCount($data['Prison']['id'],$key,$fromDate,$toDate,'Debtor'); ?>
