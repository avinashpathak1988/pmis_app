                        ...
                        <div class="row">
                                ...
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                           <?php echo $this->Form->input('court_id',array('div'=>false,'label'=>false,'class'=>'span11 pmis_select','type'=>'select','options'=>$courtList, 'empty'=>'','required'=>false,'id'=>'court_id'));?>
                                        </div>
                                    </div>
                                </div>
...
<?php
$ajaxUrl = $this->Html->url(array('controller'=>'PrisonerReport','action'=>'courtReportAjax'));
