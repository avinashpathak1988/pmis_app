    ...
    if($showOnly != 0){
         foreach($datas as $data){
                    //$convictedMales
                        ...
                        $convictedCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$showOnly,'Tribe',$fromDate,$toDate,'Convicted'); 
                        $remandCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$showOnly,'Tribe',$fromDate,$toDate,'Remand');
                        $debtorCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$showOnly,'Tribe',$fromDate,$toDate,'Debtor'); ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $tribesList[$showOnly] ?></td>
        ...
        <?php        
          ...
          foreach($datas as $data){
                ...
                foreach ($tribesList as $key => $value) {


                        $convictedCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$key,'Tribe',$fromDate,$toDate,'Convicted'); 
                        $remandCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$key,'Tribe',$fromDate,$toDate,'Remand');
                        $debtorCounts = $funcall->getTypeWiseCount($data['Prison']['id'],$key,'Tribe',$fromDate,$toDate,'Debtor'); ?>
