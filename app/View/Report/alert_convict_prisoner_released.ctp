...
<?php
$ajaxUrl        	  = $this->Html->url(array('controller'=>'report','action'=>'alertConvictPrisonerReleasedAjax'));
...
$resturl            = $this->Html->url(array('controller'=>'report','action'=>'alertConvictPrisonerReleased'));
