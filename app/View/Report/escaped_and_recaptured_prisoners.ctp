...
<?php
$ajaxUrl        	  = $this->Html->url(array('controller'=>'report','action'=>'escapedAndRecapturedPrisonersAjax'));
...
$resturl            = $this->Html->url(array('controller'=>'report','action'=>'escapedAndRecapturedPrisoners'));
