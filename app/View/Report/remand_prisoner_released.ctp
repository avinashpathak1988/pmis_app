...
<?php
$ajaxUrl        	  = $this->Html->url(array('controller'=>'report','action'=>'remandPrisonerReleasedAjax'));
...
$resturl            = $this->Html->url(array('controller'=>'report','action'=>'remandPrisonerReleased'));
