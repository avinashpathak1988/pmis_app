                    ...
                    <label class="control-label"><?php echo isset($modelArr['month'])?$modelArr['month']:'Month'?></label>
                                    ...
                                    <div class="controls">
                                        <?php
                                         ...
                                         echo $this->Form->input('month',array('div'=>false,'label'=>false,'type'=>'text', 'class'=>'form-control pmis_select', 'id'=>'month','style'=>'width:120px;','type'=>'select','empty'=>'--Select--','options'=>$month));
...
<?php
$ajaxUrl        	  = $this->Html->url(array('controller'=>'report','action'=>'alertOnEventsAjax'));
...
$resturl            = $this->Html->url(array('controller'=>'report','action'=>'alertOnEvents'));
