                     ...
                     <div class="row" style="padding-bottom: 14px;">             
                        ...
                        <div class="span4">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php echo $this->Form->input('from_date',array('div'=>false,'label'=>false,'type'=>'text', 'class'=>'form-control', 'id'=>'from_date', 'readonly'=>true,'value'=> date("01-m-Y")));?>
                                    </div>
                                </div>
                            </div>
                            <div class="span4">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php echo $this->Form->input('to_date',array('div'=>false,'label'=>false,'type'=>'text', 'class'=>'form-control', 'id'=>'to_date', 'readonly'=>true,'value'=> date("t-m-Y")));?>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php
$ajaxUrl        = $this->Html->url(array('controller'=>'report','action'=>'releaseOnMedicalGroundAjax'));
...
$resturl            = $this->Html->url(array('controller'=>'report','action'=>'releaseOnMedicalGround'));
