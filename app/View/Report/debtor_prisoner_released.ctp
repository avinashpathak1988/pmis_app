...
<?php
$ajaxUrl        	  = $this->Html->url(array('controller'=>'report','action'=>'debtorPrisonerReleasedAjax'));
...
$resturl            = $this->Html->url(array('controller'=>'report','action'=>'debtorPrisonerReleased'));
