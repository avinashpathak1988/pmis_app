...
<?php
    $this->Paginator->options(array(
        ...
        'url'                       => array(
            'controller'            => 'report',
            'action'                => 'childrenDueHandedOverAjax',
            'prison_id'      		=> $prison_id,
            'from_date'      		=> $from_date,
            'to_date'        		=> $to_date, 
        )
...
<?php
    $exUrl = "childrenDueHandedOverAjax/prison_id:$prison_id/from_date:$from_date/to_date:$to_date";
...
?>
        ...
        <td><?php if($val[0]['mother_name']!='')echo ucwords(h($val[0]['mother_name']));else echo Configure::read('NA'); ?>&nbsp;</td>
		</tr>
<?php
			$rowCnt++;
		}
