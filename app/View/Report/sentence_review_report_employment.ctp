...
<?php
$ajaxUrl        	  = $this->Html->url(array('controller'=>'report','action'=>'sentenceReviewReportEmploymentAjax'));
...
$resturl            = $this->Html->url(array('controller'=>'report','action'=>'sentenceReviewReportEmployment'));
