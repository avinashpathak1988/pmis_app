...
<?php
$ajaxUrl        	  = $this->Html->url(array('controller'=>'report','action'=>'alertReleaseDateConvictAjax'));
...
$resturl            = $this->Html->url(array('controller'=>'report','action'=>'alertReleaseDateConvict'));
