...
?>
        <tr>
			...
			<td><?php echo date('d-m-Y',strtotime($data['Courtattendance']['commence_date'])); ?>&nbsp;</td>
            <td>
			<?php if($data['Courtattendance']['status'] == 'Draft') { ?>
				 <?php echo $this->Form->create('causelistEdit',array('url'=>'/courtattendances/index/'.$uuid.'#produceToCourt','admin'=>false));?> 
                  ...
                  <div class="modal-body">
				    <table class="table table-bordered data-table table-responsive">
						...
						<tr>
							...
							<tr>
                                <td><b>Date of Cause List</b></td>
                                <td><?php echo date('d-m-Y',strtotime($data['Courtattendance']['cause_date']));?></td>
                            </tr>
							<tr>
                                <td><b>Session Commence Date</b></td>
                                <td><?php echo date('d-m-Y',strtotime($data['Courtattendance']['commence_date']));?></td>
                            </tr>
							 <tr>
                                <td><b>File No</b></td>
							 ...
							 <tr>
								...
								<?php //echo $funcall->getMultivalue($data['Courtattendance']['offence_id'],"Offence","name");?></td>
                            </tr>
							 <tr>
                                <td><b>Count</b></td>
