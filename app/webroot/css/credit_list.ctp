                        ...
                        <div class="row" style="padding-bottom: 14px;">
                            <div class="span6">
                                <!-- <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php echo $this->Form->input('sprisoner_no',array('div'=>false,'label'=>false,'class'=>'form-control span11 alphanumeric', 'type'=>'text','placeholder'=>'Enter Prisoner No.','id'=>'sprisoner_no', 'style'=>'width:200px;'));?>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php echo $this->Form->input('prisoner_type_id',array('div'=>false,'label'=>false,'onChange'=>'showPrisonerSubType(this.value)','class'=>'form-control span11','type'=>'select','options'=>$prisonerTypeList, 'empty'=>'-- Select Prisoner Type --','required'=>false,'id'=>'prisoner_type_id'));?>
                                    </div>
                                </div> -->
                                <div class="control-group">
                                    <label class="control-label">Currency:</label>
                                    <div class="controls">
                                       <?php echo $this->Form->input('currency',array('div'=>false,'label'=>false,'class'=>'form-control span11','type'=>'select','options'=>$currencyList, 'empty'=>'-- Select Status --','required'=>false,'id'=>'currency'));?>
                                    </div>
                                </div>
                            </div>
                            <div class="span6">
                                <!-- <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php echo $this->Form->input('epd_from',array('div'=>false,'label'=>false,'class'=>'form-control span11 from_date mydate','type'=>'text','placeholder'=>'Start Date','id'=>'epd_from',"readonly"=>true, 'style'=>'width:43%;'));?>
                                        To
                                        <?php echo $this->Form->input('epd_to',array('div'=>false,'label'=>false,'class'=>'form-control span11 to_date mydate','type'=>'text','placeholder'=>'End Date','id'=>'epd_to',"readonly"=>true, 'style'=>'width:43%;'));?>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                       <?php echo $this->Form->input('status',array('div'=>false,'label'=>false,'class'=>'form-control span11','type'=>'select','options'=>$statusList, 'empty'=>'-- Select Status --','required'=>false,'id'=>'status','default'=>$default_status));?>
                                    </div>
                                </div>
                            </div>
                            <div class="span12 add-top" align="center" valign="center">
                                ...
                                <?php echo $this->Form->input('Reset', array('type'=>'reset', 'div'=>false,'label'=>false, 'class'=>'btn btn-danger', 'onclick'=>"resetData('SearchCreditListForm')"))?>
                            </div>                        
                        </div> 
...
<?php
$ajaxUrlCredit = $this->Html->url(array('controller'=>'properties','action'=>'dataAjax'));
